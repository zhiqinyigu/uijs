...
UI.DatePicker = {
	...
	show : function(e,o){ //Parameter:target,lang,format,self,disabledWeekDays,disabledWeeks,disabledDays,showWeek,selectWeek
		var E = UI.E(e);
		E.stop();
		...
		for (var row = 1,currentWeek;row < 7;row++) {
			...
			if (this.format.hasString('d')) {
				for (var col = 1;col < 8;col++) {
					...
					if (disabled || this.disabledWeekDays[col - 1] || this.disabledDays[display_date - 1] || this.disabledWeeks[row] || (col == 1 ? this.disabledWeekDays[7] : false)) {
