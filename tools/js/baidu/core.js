...
BBEffect.changeDisplay=function (P,W,X,Q,U) {
	...
	if(X&1) {
		...
		initialCss:V,alterableCss:R,finalCss:b
	});
	if(U) {
...
function Panel(D,C) {
	...
	var C=0;
	return {
		useIframe:null,draggable:false,resizable:false,panelRect:{
		},PANEL_CLASS:"panel",IFRAME_CLASS:"panel-iframe",INNER_CLASS:"panel-content",_panel:null,_visible:false,_inner:null,_iframe:null,_initialized:false,_initPanel:function (A,B) {
			...
			this._iframe=Dom.createElement("iframe",{
				className:this.IFRAME_CLASS,frameBorder:0,src:BB.JSPATH+"util/panel/blank.html"
			});
			...
			if("function"==typeofCollectGarbage) {
				CollectGarbage();
			}
		},detect:function () {
