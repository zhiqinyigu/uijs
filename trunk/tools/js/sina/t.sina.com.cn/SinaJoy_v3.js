function SinaDotAdJs1() {
	...
	this.isIE6 = (navigator.appName == "Microsoft Internet Explorer" && this.trim_Version == "MSIE6.0")
			? true
			: false;
	this.isXHTML = document.compatMode == "CSS1Compat" ? true : false;

	this.bdy = (document.documentElement && document.documentElement.clientWidth)
...
function lyhnb(u) {
	...
	this.initSJ = function(d) {
		eval(o.initWrap(0x02, "sinaJoy", "SJmWrap", d.w, 0, "fixed", "0", "",
				"", "0", "99", "0", "0", "none", "block"));
		...
		if (o.isIE6 || !o.isXHTML) {
			...
			pthis.timerSJ_pos = setInterval(function() {
						pthis.topSJ = o.bdy.scrollTop + o.bdy.offsetHeight
								- pthis.heightSJ;
		...
		eval(o
				.initWrap(
						...
						"0",
						"0",
						"url(http://d1.sina.com.cn/shh/demo/091216/cls_66x22.gif) no-repeat",
						"block"));
...
function popSinaJoy() {
	...
	if (purl.match(r1) || purl.match(r2) || purl.match(r3) || purl.match(r4)
			|| purl.match(r5) || purl.match(r6)) {
		ld = new Date();
		if ("" != cpop) {
			ld.setTime(cpop);
		}
		...
		if ("" == cpop
				|| nd.getDate() != ld.getDate()
				|| (nd.getDate() == ld.getDate() && ld.getHours() < 12 && nd
						.getHours() >= 12)) {
