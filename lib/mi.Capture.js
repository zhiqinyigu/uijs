...
UI.ready(function(){
	if(MI.Capture.enable){
		...
		MI.Capture.upload = function(){
			var clipBoardImage = MI.Capture.screen.IsClipBoardImage,
				clipboardFiles = MI.Capture.uploader.GetClipboardFiles(),
				fileID;
			if((clipBoardImage || clipboardFiles) && MI.talkBox && MI.talkBox.pic){
