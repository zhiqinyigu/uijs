...
MI.AutoCmt = function(o){ //Auto Complete
	/*
		URL : /asyn/newMsgCount.php?type=4,3,2
		{
			"result":0,
			"msg":"成功",
	...
	*/
	...
	Self.key = o.key;
	UI.EA(o.target,'keyup',function(e){
		var E = UI.E(e);
...
MI.AutoCmt.prototype = {
	_body : UI.html('<div class="autoCmt" style="display:"><ul><li class="on"><b>k</b>aka (clarence)</li></ul></div>')[0]
}
