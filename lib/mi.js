...
MI.TalkBox.prototype = {
	...
	countTxt : function(){
		...
		if (Self.autoSave && length <= this.txtMax && MI.isStorage) {
			...
			Self.delay.save = setTimeout(function(){
					try{
						MI.Storage(draft,Self._txt.value.replace(new RegExp(Self.txtTopic,'g'),'') || '');
					}catch(e){};
			},200);
		}
	},
	...
	send : function(){
		...
		//Go To User's Page
		if (!Self.type && content.match(/^@[\w|-]{0,64}$/g) && content.length > 1) {
...
MI.TalkList = function(id){ //Talk List
	...
	Self.comtBox.success = function(){
		...
		Self.talkBox._comts.src = '/comment/comment.php?id=' + id;
	...
	reply : function(id,type){ //type : undefined(reply) 1(relay) 2(comt)
		...
		if (!this.talkBox.display) {
			...
			if (type == 2) {
				...
				this.talkBox._comts.src = '/comment/comment.php?id=' + id;
...
MI.DialogMsg = function(o){
	...
	o.tmpl = '<div class="bg"></div><div class="D"><div style="position:absolute;z-index:9999;top:0;left:25%;width:542px" class="CR"><table border="0" cellspacing="0" cellpadding="0" class="tbSendMsg"><tr><td class="tl"></td><td class="tm"></td><td class="tr"></td></tr><tr><td class="lm"></td><td><div class="DWrap"><div class="DTitle"></div><div class="DClose close"></div><div class="DLoad"></div><div class="DCont"></div></div></td><td class="rm"></td></tr><tr><td class="bl"></td><td class="bm"></td><td class="br"></td></tr></table></div></div>';
