				...
				*/
				var imageUploadName = 'imageUpload_' + MI.random(),
					html = UI.html('<div class="cutBox" style="display:none;">\
						...
						<p style="display:' + ((MI.user.medal[0]>=2 || MI.user.isLab) && !UI.B.ipad ? '':'none') +'"><span class="ico_wpic"></span><a href="#" class="text2pic txt mOut" title="' + _('文字转图片') + '">' + _('文图') + '</a></p></div>\
				...
				var picNav = function(j){
					...
					if (!(UI.B.ipad)&&!(UI.hasClass(document.body,'ipad'))&&!Self.pic && UI.C(Self._picLoading,'display') == 'none' && MI.TalkBox.captureEnable()){
