			...
			UI.get('/asyn/newMsgCount.php',{type:3,r:MI.random(10000)},function(data){
				...
				if (data.result == 0) {
					...
					if (data.info && num) {
						...
						Self._new.innerHTML = '<a href="javascript:void(0)">有' + tip + '新广播，点击更新</a>';
						UI.show(Self._new);
...
MI.TalkList.prototype = {
	...
	reply : function(id,type){
		...
		if (!this.talkBox.display) {
			...
			var replyTitle = '转播 <b>' + name + '</b>:&nbsp;"' + MI.string.escape(content.slice(0,30)),relayTitle = '回复 <b>' + name + '</b>:';
