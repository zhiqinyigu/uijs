...
MI = {
	...
	tmpl : {
		...
		reply : '<div class="talkWrap"><div class="SA"><em>◆</em><span>◆</span></div>\
			...
			<div class="bot">\
				<div class="insertFun"><div class="sendList newTopic"><a href="#" class="creatNew txt" title="' + _('汇聚相同热点的广播') + '" tabindex="3"><em class="sico ico_topic"></em>' + _('话题') + '</a></div><div class="sendList atSome"><a class="txt" href="#" title="' + _('@朋友帐号就可以提到他') + '"><em class="sico ico_at"></em>' + _('朋友') + '</a></div><div class="sendList insertFace"><a class="txt" href="#" title="' + _('表情') + '"><em class="sico ico_face"></em>' + _('表情') + '</a></div></div>\
				<div class="left"></div>\
	 ...
	 */
	countTxt : function(value,countUrl,zhCount){
	...
	newCount : function(type, url, time){
		...
		var fail = 0;
		function newCout(){
			var urlData = {type:type,r:MI.random()}; 
		...
		//var url = 'http://www.qq.com/mb/mat1/mb/',
			js = {
				...
				mi : {
					...
					TalkListShare : '110810',
					Scroll : '101111',
					Capture : '110817',
					Music : '110825a',
					QQMusicInstance : '110720',
 ...
 * @param {object} object
 *          场景参考：http://tapd.oa.com/v3/microblog/wikis/view/%E7%94%A8%E6%88%B7%E8%A1%8C%E4%B8%BA%E5%8F%8D%E9%A6%88%E7%BB%9F%E8%AE%A1
		...
		UI.ready(function(){
			...
			*/
			...
			if (Self._music) {
				...
				Self.musicMoreBtn = {
					body : UI.html('<div class="cutBox">\
						<p style="display:' + (UI.B.ipad ? 'none':'') + '"><a class="txt mRecord" href="#" title="' + _('可以通过麦克风录下声音') +'"><em class="sico ico_record"></em>' +_('录音') + '</a></p>\
						<p style="display:' + (UI.B.ipad ? 'none':'') + '"><a class="txt mUpload" href="#" title="' + _('自己上传音频') +'"><em class="sico ico_upAudio"></em>' +_('上传') + '</a></p></div>')[0],
					recordHtml:'<div class="recordWrap"></div>',
					recordFlash:'<a class="close" href="#" title="' + _('关闭') + '"></a><object width="270" height="150" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab" id="flashTest" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"><param value="http://mat1.gtimg.com/www/mb/swf/MusicRecord/Main_110712.swf" name="movie"><param value="high" name="quality"><param value="#FFFFFF" name="bgcolor"><param name="wmode" value="transparent" /><param value="always" name="allowScriptAccess"><param value="all" name="allowNetworking"><embed width="270" height="150" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" wmode="transparent" allownetworking="all" allowscriptaccess="always" loop="false" play="true" name="flashTest" bgcolor="#FFFFFF" quality="high" src="http://mat1.gtimg.com/www/mb/swf/MusicRecord/Main_110712.swf"></object>',
					recordBtn:null,
					recordBody:null,
					showAble:true,
					close:null,
					...
					show:function(){
						var Self = this;
						if(Self.showAble) UI.addClass(Self.target,'hover');
					},
					hide:function(){
						var Self = this;
						Self.delay = setTimeout(function(){
							UI.removeClass(Self.target,'hover');
						},100);	
					}
				};
				if(!UI.B.ipad && MI.user.isLab){
					Self.musicMoreBtn.build(Self._music);
					Self._music.onmouseover = function(){
						clearTimeout(Self.musicMoreBtn.delay);
						!($$(Self._sendStatus,'.uploadMusic')[0]) && Self.musicMoreBtn.show();
					}
					Self._music.onmouseout = function(){
				...
				*/
				...
				if(Self._videoClose){
					Self._videoClose.onclick = function(){
						...
						UI.removeClass(Self._videoAnchor,'disabled');
			...
			//		Self.removeSrcpic();//关闭粘贴图片链接弹层
					...
					!($$(Self._sendStatus,'.uploadVideo')[0]) && UI.show(Self._videoBox);
					if(UI.trim(Self._videoTxt.value)){
			...
			if (Self._pic) {
				...
				*/
				var imageUploadName = 'imageUpload_' + MI.random(),
					...
					uploadPicS = UI.html('<div class="sendThumbs uploadPicS"><span style="display:none" class="pidLoad loading">' + _("上传中") + '<a class="cancel" href="#">[' + _("取消") + ']</a></span><span style="display:none;" class="preview"><span class="link"><em class="sico ico_pic"></em></span><a href="#" class="del">[' + _("删除") + ']</a></span><iframe id="' + imageUploadName + '" name="' + imageUploadName + '" src="about:blank" style="display:none"></iframe></div>')[0],
					html = '<div class="D3 insertPic" style="display:none;">\
						<div class="tabStyle3"><ul><li class="select"><a href="javascript:void(0);">' + _('本地上传') + '</a></li><li><a href="javascript:void(0);">' + _('多图') + '</a></li><li><a href="javascript:void(0);">' + _('链接') + '</a></li><li><a href="javascript:void(0);">' + _('文图') + '</a></li><li style="display:' + (UI.parseUrl().camera ? '' : 'none') + '"><a href="javascript:void(0);">' + _('拍照') + '</a></li></ul><a class="close" title="' + _('关闭') + '" href="#"></a></div>\
						<div class="picDiv singlePic">\
						...
						<div class="picDiv hideDcnt cameraPic">\
							<div class="flashWrap"></div><div class="clear"><p class="left"><span class="cNote tip"></span></p><p class="right"><button class="btnSend btn1">' + _('确定') + '</button><button class="btn1 btnCancel">' + _('取消') + '</button></p></div><div class="maskLoading"></div>\
						</div>\
						<div class="SA"><em>◆</em><span>◆</span></div>\
					</div>';

				Self._picBox = UI.html(html)[0];
				Self._picForm = $$(Self._picBox,'.sPicForm')[0];
				Self._picBtn = $$(Self._picBox,'.sPicForm input')[0];

				UI.append(uploadPicS,Self._sendStatus);
				UI.after(Self._picBox,Self._sendStatus);

				if (MI.user.fun.turnPic) {
					UI.append(MI.PicTurn.build(Self),uploadPicS);
				...
				Self._picTab = $$(Self._picBox,".tabStyle3 li");
				Self._picDiv = $$(Self._picBox,".picDiv");
				Self._picClose = $$(Self._picBox,".tabStyle3 .close")[0];
			//	Self._picSingle = Self._picTab[0]; //单张图片上传
			//	Self._picMulti = Self._picTab[1];//图片多图项
				Self._picCapture = $$(Self._picBox, ".capture");//图片截屏项
				Self._sourcepicUrl = Self._picTab[2];//图片粘贴项
			//	Self._text2Pic = Self._picTab[3];  //文图
			//	Self._picCamera = Self._picTab[4]; //视频拍照
				Self._sourcepicBox = Self._picDiv[2];//图片粘贴浮动层
				Self._sourcepicTxt = $$(Self._sourcepicBox, ".inputTxt")[0];
				Self._sourcepicBtn = $$(Self._sourcepicBox, ".btn1")[0];
				...
				if(UI.B.ipad || MI.user.fun.qbUpload) {
					UI.hide(Self._picTab[1]);
					UI.hide(Self._picTab[3]);
					UI.hide(Self._picTab[4]);
					UI.hide(Self._picCapture[0]);
				}

				//切换tab
				UI.each(Self._picTab,function(o,i){
					o.onclick = function(){
						if(UI.hasClass(this,'select')) return;
						UI.each(Self._picDiv,function(d,j){
							if(i==j) {
								UI.addClass(Self._picTab[j],'select');
								UI.removeClass(Self._picDiv[j],'hideDcnt');
							}	
							else {
								UI.removeClass(Self._picTab[j],'select');
								UI.addClass(Self._picDiv[j],'hideDcnt');
							}
						});
						tabEvent(i);
						Self.flashCapture = 0; //还原为非截屏到flash模式
					}
				});
				...
				//关闭按钮
				Self._picClose.onclick = function(){
					Self.hidePicBox();
					return false;
				}
				
				//关闭浮层
				Self.hidePicBox = function(){
					if(Self._picBox.style.display == 'none') return;
					Self.resetSourcePic && Self.resetSourcePic(); 	//清空链接状态
					...
					UI.hide(Self._picBox);
				}

				//打开浮层
				Self.showPicBox = function(i){
					if(Self._picBox.style.display != 'none') return false;
					Self.hideMedia();
					if(UI.hasClass(Self._picTxt,'disabled')) return false;
					UI.show(Self._picBox);
					Self._picTab[i || 0].onclick();  //触发指定tab展开，默认第一个表单上传
					Self._picTxt.blur();
					return false;
				}
				Self._picTxt.onclick = function(){
					Self.showPicBox(0);
					return false;
				}; 
				...
				if (!MI.user.fun.qbUpload &&!(UI.B.ipad)&&!(UI.hasClass(document.body,'ipad'))&&!Self.pic && (!Self._picLoading || UI.C(Self._picLoading,'display') == 'none') && MI.TalkBox.captureEnable()){
							UI.each(Self._picCapture,function(o,i){
								UI.show(o);
								o.onclick = function(){
									MI.app({
										Capture:function(){
											if (MI.Capture && MI.Capture.enable){
												Self.flashCapture = i; //是否为多图flash截屏按钮
				...
				Self.removeSrcpic = function(){
					Self._picLoading.style.display == 'none' && Self._picPreview.style.display == 'none' && UI.removeClass(Self._picTxt,'disabled');
				}
...
MI.TalkBox.prototype = {
	...
	countTxt : function(){
		var Self = this,
			...
			talkTip,
			length;
		Self.length = length = MI.countTxt(value,Self.countUrl,Self.zhCount);
		...
		if(MI.Text2Pic && Self.showPicBox && !UI.hasClass(document.body,'ipad')) { //只在顶部广播对话框出现
	...
	hideMedia : function(){ //隐藏浮层 - 视频/音乐/投票
		var Self = this;
		Self._video && UI.hide(Self._videoBox);
		!($$(Self._sendStatus,'.uploadVideo')[0]) && UI.removeClass(Self._videoAnchor,'disabled');
		Self._music && MI.Music && Self._musicBox && MI.Music.hide();
		!($$(Self._sendStatus,'.uploadMusic')[0]) && UI.removeClass(Self._musicAnchor,'disabled');
		Self._vote && Self.hideVote && Self.hideVote();
		Self._music && Self.musicMoreBtn && Self.musicMoreBtn.hideRecord();
		Self._pic && Self._picBox && Self.hidePicBox();
	},
	/**
	 * 隐藏发表框
	 *            @example
...
/*		if(Self.emotion) { //只在主页和广播页刷新timeline
			Self.addList = MI.moodAddList;
			//if(MI.boss !=11 && MI.boss != 13) addCheck = 0;
		}
*/	
		if (Self.source) {
	...
	uploadPic : function(){
		var Self = this;
		if (Self.flashCapture) {   //截屏到多图时loading
			UI.addClass(Self._picCapture[1],'loading');
		}	
		else {
			Self.hidePicBox();
	...
	addPic : function(o){
		...
		if (o.result == 0) {
			if(Self.flashCapture) { //截屏到多图flash
				MI.PhotoMultiUpload.captureImg(o.info.image + "/2000");
				UI.removeClass(Self._picCapture[1],'loading');
				return;
			}
			//Self.hidePicBox();
			!(UI.hasClass(Self._sendCnt,'hasMedia')) && UI.addClass(Self._sendCnt,'hasMedia');
			...
			if (turnPicAble) {
				...
				UI.addClass(Self._picTxt,'disabled');
			}
			else {
				UI.append(Self._uploadPicS,Self._sendStatus);
				UI.addClass(Self._picTxt,'disabled');
				Self._picLink.innerHTML = '<em class="sico ico_pic"></em><a href="' + pic + '/2000" class="fileName" target="_blank" style="position:relative;">' + fileName + '<span class="simg" style="cursor:default;_width:160px;"><img  src="' + pic +  "/160" + '" /><span style="white-space:nowrap;width:100%;padding:5px 0;display:' + (UI.B.ipad ? 'none':'inline-block' ) + '"><span class="useFilter" style="cursor:pointer;display:inline;" href="javascript:void(0)">' + _('魔法滤镜') + '</span></span></span></a>';
	...
	delPic : function(){
		...
		if (Self._pic) {
			...
			if(UI.B.chrome) {  //解决chrome下 传同一张图片不触发change事件的问题
				...
				Self._picBtn = UI.GT(Self._picForm,'input')[0];
				Self._picBtn.onchange = Self.picChange;
			}
			Self.countTxt();
			UI.removeClass(Self._picTxt,'disabled');
			...
			if (Self._music) {
				MI.app({
							Music : function() {
								...
								MI.Music.addPreview(Self._music, '', true);
								MI.Music.hide();
							}
						});
			}
	...
	cancelPic : function(){
		if (this._pic) {
			...
			this._picForm.reset();
			UI.removeClass(this._picTxt,'disabled');
			this._picCapture[1] && UI.removeClass(this._picCapture[1],'loading');
...
MI.PicTurn = {
	...
	set: function(src) {
		var Self = this;
		Self._imgCt.innerHTML = '<img src="' + src + '/160" /><div style="width:100%;display:' + (UI.B.ipad ? 'none':'inline-block') + ';padding:5px 0;white-space:nowrap;"><a href="#" class="useFilter" style="float:none;display:inline;">' + _('魔法滤镜') + '</a></div>';
		...
		if (mThumbsBox){ //歌单
			...
			if (albumPicImg){
				albumPicImg.onerror = function(){
					this.src = 'http://mat1.gtimg.com/www/mb/images/music_pic.jpg';
					this.onerror = null; 
				}
			}
		}
	...
	addEvent : function(el,type){
		...
		function addEvent(element){
			UI.each($$(element || document.body,'.addAttention'),function(o){
				var del = UI.html(type ? '<div class="foFun disabled" style="display:none">' + _('已收听') + '</div>' : '<a href="#" class="delAttention" style="display:none">' + _('取消<i class="l"></i>') + '</a>')[0];
				UI.after(del,o);
...
UI.ready(function(){
	...
	//Lab Test
	if (UI.parseUrl().newMusic){ // || 'xhlv,lunar_moon,piboye,armstrong,pagepeng,zhengguo,hadeszh'.hasString(MI.user.account)
