...
MI.TalkList.pic = function(){ //Picture Event
	...
	this.sUrl = this.sUrl || this.src;
	if (this.src == this.sUrl) {
		this.src = UI.A(this,'rel');
		//UI.C(this,'marginBottom','');
	}
	else {
		this.src = this.sUrl;
		//UI.C(this,'marginBottom',this.m);
	}
...
MI.TalkList.picTool = function(){
	...
	pic.m = pic.r % 2 != 0 ? pic.w - pic.h + 'px' : 0;
	//pic.style.margin = '0 0 ' + pic.m + '0';
	if (UI.B.ie) {
