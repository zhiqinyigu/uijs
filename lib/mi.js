			...
			Self._btn.onclick = function(){
				...
				switch (Self.type) {
					case null:
						...
						break;
					case 1:
						MI.Boss('btnSendReply');
						break;
					case 2:
						MI.Boss('btnSendRelay');
						break;
					case 3:
						MI.Boss('btnSendMsg');
						break;
...
MI.Boss = function(op){ //Using : MI.Boss('frontClick');
	var ouin = UI.trim(UI.cookie("o_cookie"));
	MI.Boss.pic.src="http://btrace.qq.com/collect?sIp=&iQQ=" + ouin + "&sBiz=microblog&sOp=" + op +"&iSta=0&iTy=18&iFlow=0";
}
MI.Boss.pic = new Image();
/*
