...
MI.Bos = function(op,value,random){ //Boss Using : MI.Bos('frontClick');
	...
	try{
		...
		MI.Bos.pic[UI.random(0,9)].src = 'http://btrace.qq.com/collect?sIp=&iQQ=' + ouin + '&sBiz=microblog&sOp=' + op + '&iSta=0&iTy=214&iFlow=0' + data + '&r=' + MI.random();
	}catch(e){}
}
MI.Uin = function(){
			...
			success : function(data){
				...
				*/
				...
				setTimeout(function(){
					...
					MI.Speed('t_asyn_talk',0.05,Time_1,Time_2,Time_3);
				},0);
			}
		});
