...
MI = {
	...
	tmpl : {
		...
		reply : '<div class="talkWrap"><div class="SA"><em>◆</em><span>◆</span></div>\
			...
			<div class="bot">\
				<div class="insertFun"><div class="sendList insertFace"><a class="txt" href="#" title="' + _('表情') + '"><em class="sico ico_face"></em>' + _('表情') + '</a></div><div class="sendList newTopic"><a href="#" class="creatNew txt" title="' + _('汇聚相同热点的广播') + '" tabindex="3"><em class="sico ico_topic"></em>' + _('话题') + '</a></div><div class="sendList atSome"><a class="txt" href="#" title="' + _('@朋友帐号就可以提到他') + '"><em class="sico ico_at"></em>' + _('朋友') + '</a></div></div>\
				<div class="left"></div>\
			...
			MI.newTopMsgBox = function(data){
				...
				if(!navMsgList) {
					navMsgList = UI.html('<ul class="topNavSub" style="display: none; ">\
						<li><a href="http://t.qq.com/at" onclick="MI.Bos(\'btnNewNavNews\')">' + _('提到我的') + '<b>0</b></a></li>\
						<li><a href="http://t.qq.com/' + MI.user.account + '/follower" onclick="MI.Bos(\'btnNewNavFollower\')">' + _('听众') + '<b>0</b></a></li>\
						<li><a href="http://t.qq.com/messages/inbox" onclick="MI.Bos(\'btnNewNavMessage\')">' + _('私信') + '<b>0</b></a></li>\
						<li style="display:none"><a href="http://t.qq.com/at?filter=1" onclick="MI.Bos(\'btnNewNavFollowing\')">' + _('我收听的人') + '<b>0</b></a></li>\
						<li style="display:none"><a href="http://t.qq.com/at?filter=2" onclick="MI.Bos(\'btnNewNavAuth\')">' + _('认证用户') + '<b>0</b></a></li>\
						<li style="display:none"><a href="http://t.qq.com/at?qun" onclick="MI.Bos(\'btnNewNavGroup\')">' + _('微群') + '<b>0</b></a></li>\
					</ul>')[0];
				...
				var msgBoxType = { //消息type : 对应的元素在消息盒子下拉菜单中的位置
					2 : 3, //私信
					1 : 2, //新听众
					4 : [1,4,5], //@消息[所有，我收听的，认证用户]
					14 : [1,4,5], //@有理由的消息[所有，我收听的，认证用户]
					13 : 6  //微群
				};
				var maxNum = 999;
				...
				UI.each(msgBoxNum,function(p,i){
					...
					if(i == 4 || i==5 || i==6) return false; //临时隐藏我收听的，认证用户和微群
					if(p) {
						if(i == 0) {
							p = p > maxNum ? maxNum + '+' : p;
						} else if(i == 2) { //新增听众 
						...
						//	(i== 4 || i == 5) ? UI.show(item.parentNode) :  
								UI.show(item); 								//其他
					} else {
	...
	ajax : function(o,lonely){
		var iframe = '_ajaxProxy', ajax = '_ajax', xhr = '_ajaxXhr', host = MI.api.host, hostMatch, hostName ,isObject = UI.isObject(o);
		if (isObject) {
			if (o.url) {
			...
			if (host.hasString('http://' + document.location.host)) { //同域跳过
				return UI.ajax(o);
			}
		}
...
MI.swf = (function(){
	...
	return {
		MusicRecord : host + 'MusicRecord/Main_110920.swf', //录音
		CameraPhoto : host + 'CameraPhoto_110920.swf', //拍照
		Text2Pic : host + 'Text2Pic_110926.swf', //文图
		FilterPhoto : host + 'FilterPhoto_110804.swf', //滤镜
		MultiPhoto : host + 'MultiPhoto_110922.swf' //多图
	}
})();
/**
 * 异步接口地址
 ...
 * @param {integer} type talkbox 类型, 0: 原创, 1: 转播, 2: 回复, 3: 评论
