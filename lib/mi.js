...
MI.TalkList = function(id){ //Talk List
	...
	//Delete Confirm
	Self._confirm = UI.html('<div class="delChose">真的要删除此信息？<br><input value="确定" type="button">&nbsp;&nbsp;<input value="取消" type="button"></div>')[0];
