			...
			if (Self._pic) {
				...
				*/
				var imageUploadName = 'imageUpload_' + MI.random(),
					html = UI.html('<div class="cutBox" style="display:none;"><p style="display:' + (UI.B.ipad ? 'none':'')   +  '"><span class="ico_pics"></span><a href="#" class="multi txt mOut" title="' + _('支持多张图片拼接') + '">' + _('多图') + '</a></p><p style="display:none;"><span class="ico_cut"></span><a href="#" class="txt mOut" title="'+_("支持粘贴QQ截屏等剪贴板内容") +'">'+_("截屏") +'</a></p><p><span class="ico_pUrl"></span><a href="#" class="txt mOut" title="'+_("粘贴图片链接")+'">'+ _("链接") +'</a></p></div><span class="pidLoad" style="display:none">' + _("上传中") + ' <a href="#" class="cancel">[' + _("取消") + ']</a></span><span style="display:none" class="preview"><span class="link"></span><a href="#" class="del">[' + _("删除") + ']</a></span><iframe id="' + imageUploadName + '" name="' + imageUploadName + '" src="about:blank" style="display:none"></iframe>'),
