...
MI.TalkList = function(id){ //Talk List
	...
	Self._relay = UI.html(MI.tmpl.reply.replace('<div class="left"></div>','<div class="left"><label for="replayQzoneCheckbox" style="display:none"><input id="replayQzoneCheckbox" type="checkbox" class="check1">' + _('分享到空间') + '</label></div>'))[0];
