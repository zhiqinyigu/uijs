...
MI = {
	...
	tmpl : {
		...
		picTool : '<div class="tools"><a href="#" class="btnBack" title="向左转"></a><span>|</span><a href="#" class="btnPrev" title="向右转"></a><a href="#" class="btnOriginal" target="_blank">查看原图</a></div>',
	...
	addEvent : function(el){
		...
		if (picBox) {
			for (var i = 0,num = picBox.length;i < num;i++) {
				...
				UI.before(UI.html(MI.tmpl.picTool)[0],link);
