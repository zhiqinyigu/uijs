...
MI = {
	...
	tmpl : {
		list : '<li id="<%=info.id%>"><div class="userPic"><a href="/<%=info.account%>" title="(<%=info.nick.toTitle()%>@<%=info.account%>)"<%if(' + V2 + '.type==2){%> class="masPic"<%}%>><img src="<%=info.userPic%>"' + V6 + '/></a><%if(' + V2 + '.type==2){%><%=' + V2 + '.cusPic%><%}%></div><div class="msgBox"><div class="userName"><a href="<%=info.account%>" title="(<%=info.nick.toTitle()%>@<%=info.account%>)"><strong><%=info.nick%></strong></a><%if(info.vip){ ' + V4 + '}%> <%=info.action%></div><div class="msgCnt"><%=info.content%></div><%if(' + V2 + '.type==1){%><div class="replyBox"><%=' + V2 + '.content%></div><%}%><div class="pubInfo"><span class="left"><%=info.time%> 发自<%=info.sorurce%> <%if(' + V2 + '.type==2){%><a class="view zfNum"' + V5 + '>查看对话</a></b><%}%></span><p class="funBox"><a' + V8 + '\'<%=info.id%>\',this)" class="del">删除</a></p></div><%if(' + V2 + '.type==2){%><div class="talkDetail"><%=' + V2 + '.nick%>: <%=' + V2 + '.content%></div><%}%></div></li>',
		listAll : '<%for(var i=0,n=talk.length;i<n;i++){%><li id="<%=talk[i].id%>" rel="<%=talk[i].timestamp%>"><%if(!guest){%><%if(' + V1 + ' && talk[i].type==4){%><div class="userPic"><a href="/<%=talk[i].name%>"' + V7 + ' class="masPic"><img src="<%=talk[i].pic%>"' + V6 + '/></a><a href="/<%=' + V1 + '.name%>" title="<%=' + V1 + '.nick.toTitle()%>(@<%=' + V1 + '.name%>)" class="cusPic"><img src="<%=' + V1 + '.pic%>"' + V6 + '/></a></div><%}else{%><div class="userPic"><a href="/<%=talk[i].name%>"' + V7 + '><img src="<%=talk[i].pic%>"' + V6 + '/></a></div><%}%><%}%><div class="msgBox"><div class="userName" rel="<%=talk[i].name%>"><a href="/<%=talk[i].name%>"' + V7 + '><strong><%=talk[i].nick%></strong></a><%if(talk[i].vip){ ' + V4 + ' }%> <%if(' + V1 + ' && talk[i].type==2){%>转播<%}else if(' + V1 + ' && talk[i].type==4){%>回复<a href="/<%=' + V1 + '.name%>" title="<%=' + V1 + '.nick.toTitle()%>(@<%=' + V1 + '.name%>)"><%=' + V1 + '.nick%></a><%if (' + V1 + '.vip){' + V4 + ' }%>:<%}%></div><div class="msgCnt"><%=talk[i].content%></div><%if(' + V1 + ' && talk[i].type==2){%><div class="replyBox">' + V3 + '<div class="userPic"><a href="/<%=' + V1 + '.name%>" title="<%=' + V1 + '.nick.toTitle()%>(@<%=' + V1 + '.name%>)"><img src="<%=' + V1 + '.pic%>"' + V6 + '/></a></div><div class="msgBox"><div class="msgCnt"><a href="/<%=' + V1 + '.name%>" title="<%=' + V1 + '.nick.toTitle()%>(@<%=' + V1 + '.name%>)"><strong><%=' + V1 + '.nick%></a><%if(' + V1 + '.vip){' + V4 + '}%></strong>: <%=' + V1 + '.content%></div><div class="pubInfo"><span class="left"><%=' + V1 + '.time%> 发自<%=' + V1 + '.from%> <a class="zfNum" href="/t/<%=talk[i].id%>"><strong class="relayNum"><%=' + V1 + '.count%></strong>人转播</a></span></div></div></div><%}%><div class="pubInfo"><span class="left"><%=talk[i].time%> 发自<%=talk[i].from%><%if(' + V1 + ' && ' + V1 + '.content && ' + V1 + '.content.length && talk[i].type==4){%> <a class="view zfNum"' + V5 + '>查看对话</a><%}%></span><p class="funBox"><%if(MI.user){if(!guest && MI.user.account==talk[i].name){%><a class="del"' + V8 + '<%=talk[i].id%>,this)">删除</a><%}else{%><a' + V5 + ' class="report">举报</a><a class="reply talk"' + V5 + '>回复</a><a class="relay zf"' + V5 + '>转播</a><%}%><%}%></p></div><%if(' + V1 + ' && talk[i].type==4){%><div class="talkDetail"><%=' + V1 + '.nick%>: <%=' + V1 + '.content%></div><%}%></div></li><%}%>',
		msg : '<li id="<%=info.id%>"><div class="msgBox"><div class="userName"><a href="/<%=info.account%>"><%=info.nick%></a><%if(info.vip){ ' + V4 + '}%></div><div class="msgCnt"><%=info.content%></div><div class="pubTime"><%=info.time%></div></div><p class="btnBox"><a class="btn"' + V8 + '<%=info.id%>,this)">删除</a></p></li>',
			...
			success : function(data){
				...
				/*data = {
					...
					info : {
						id : '123456',
						time : '5分钟前',
						content : '内容腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博内容腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博内容腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博内容腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博腾讯微博',
						form : '腾讯微博'
					}
				};*/
