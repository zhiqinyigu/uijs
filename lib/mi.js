					...
					UI.each(data.info,function(o,i){
						...
						if (o.type == 1) {
							...
							if (target && num) {
								...
								_num.title =  '有' + (num > 250 ? '超过250' : num) + '个新听众';
								UI.show(target);
								/*if (followerNum) {
