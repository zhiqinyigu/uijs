				...
				*/
				var imageUploadName = 'imageUpload_' + MI.random(),
					...
					html = '<div class="D3 insertPic" style="display:none;">\
						<div class="tabStyle3"><ul><li class="select"><a href="javascript:void(0);">' + _('本地上传') + '</a></li><li><a href="javascript:void(0);">' + _('多图') + '</a></li><li><a href="javascript:void(0);">' + _('链接') + '</a></li><li><a href="javascript:void(0);">' + _('文图') + '</a></li><li style="display:none"><a href="javascript:void(0);">' + _('拍照') + '</a></li></ul><a class="close" title="' + _('取消') + '" href="#"></a></div>\
						...
						<div class="picDiv hideDcnt cameraPic">\
							<div class="flashWrap"></div><div class="clear"><p class="left"><span class="tip"></span></p><p class="right"><button class="btnSend btn1">' + _('确定') + '</button><button class="btn1 btnCancel">' + _('取消') + '</button></p></div><div class="maskLoading"></div>\
						</div>\
