...
MI.tmpl.listAll = '<%var D=MI.TalkList.date,API=MI.api.type?"?apiType="+MI.api.type:"";for(var i=0,n=talk.length;i<n;i++){\
		...
		numAll=numRelay+numComt;%><li id="<%=talk[i].id%>"<%if(fav){%> fav="<%=talk[i].favortimestamp%>"<%}%> <%if(shield){%> shield="<%=talk[i].shield%>"<%}%> rel="<%=talk[i].timestamp%>" <%if(talk[i].qinfo){%>wqid="<%=talk[i].qinfo.wqid%>"<%}%>>\
			...
			<div class="msgBox">\
				...
				<%}%>\
				<div class="pubInfo"><span class="left"><a class="time" <%if(MI.user.fun.btnStyle!=6){%>href="http://t.qq.com/p/t/<%=talk[i].id+API%>" target="_blank"<%}%>><%=talk[i].time%></a> <%=talk[i].from%><%if(talk[i].city){%> <%=talk[i].city%><%}%><%if(!'+V1+' && numAll){if(MI.user.account){%>\
				...
				<%var at=talk[i].at;if(talk[i].atAll && talk[i].atAll > 1){%>\
					<div class="tipsBox1 at_detail">\
						<a href="#" rel="0">全部提到我的<em><%=(at[0] ? "(+" + at[0] + ")" : "")%></em></a> | <a href="#" rel="1">收听的人<em><%=(at[1] ? "(+" + at[1] + ")" : "")%></em></a> | <a href="#" rel="2">认证用户<em><%=(at[2] ? "(+" + at[2] + ")" : "")%></em></a>\
					</div>\
				<%}%>\
				<%if('+V1+' && talk[i].type==4){\
...
MI.tmpl.face = '<div class="faceWrap" style="display:none">\
	...
	<div class="faceBox" style="display:none">\
		...
		<div class="faceCell cFace2" fold="cFace" style="display:none">\
			...
			<dl fold="cFace/k" class="fline2"><dt>' + _('吕查德') + '</dt><dd><a href="#" title="' + _('谄笑') + '"></a><a href="#" title="' + _('得意') + '"></a><a href="#" title="' + _('飞吻') + '"></a><a href="#" title="' + _('尴尬') + '"></a><a href="#" title="' + _('害羞') + '"></a><a href="#" title="' + _('汗') + '"></a><a href="#" title="' + _('惊呆') + '"></a><a href="#" title="' + _('囧') + '"></a><a href="#" title="' + _('哭') + '"></a><a href="#" title="' + _('酷') + '"></a><a href="#" title="' + _('口水') + '"></a><a href="#" title="' + _('媚眼') + '"></a><a href="#" title="' + _('难过') + '"></a><a href="#" title="' + _('色') + '"></a><a href="#" title="' + _('淘气') + '"></a><a href="#" title="' + _('舔舔') + '"></a><a href="#" title="' + _('微笑') + '"></a><a href="#" title="' + _('晕死') + '"></a><a href="#" title="' + _('住嘴') + '"></a><a href="#" title="' + _('抓狂') + '"></a></dd></dl>\
			<dl fold="cFace/g" class="fline2"><dt>' + _('细哥细妹') + '</dt><dd><a href="#" title="' + _('害羞') + '"></a><a href="#" title="' + _('坏笑') + '"></a><a href="#" title="' + _('露齿') + '"></a><a href="#" title="' + _('迷茫') + '"></a><a href="#" title="' + _('微笑') + '"></a><a href="#" title="' + _('猥亵') + '"></a><a href="#" title="' + _('爱心') + '"></a><a href="#" title="' + _('大惊') + '"></a><a href="#" title="' + _('大笑') + '"></a><a href="#" title="' + _('发火') + '"></a><a href="#" title="' + _('呵呵') + '"></a><a href="#" title="' + _('可怜') + '"></a><a href="#" title="' + _('流汗') + '"></a><a href="#" title="' + _('难过') + '"></a><a href="#" title="' + _('亲亲') + '"></a><a href="#" title="' + _('挑眉') + '"></a><a href="#" title="' + _('偷笑') + '"></a><a href="#" title="' + _('无视') + '"></a></dd></dl>\
		</div>\
		<div class="faceCell cFace3" fold="cFace" style="display:none">\
			<dl fold="cFace/a"><dt>' + _('魂儿喵喵') + '</dt><dd><a href="#" title="' + _('无辜') + '"></a><a href="#" title="' + _('惊讶') + '"></a><a href="#" title="' + _('开心') + '"></a><a href="#" title="' + _('小哭') + '"></a><a href="#" title="' + _('大哭') + '"></a><a href="#" title="' + _('转眼珠') + '"></a><a href="#" title="' + _('得意') + '"></a><a href="#" title="' + _('汗') + '"></a><a href="#" title="' + _('吐舌') + '"></a><a href="#" title="' + _('顶起') + '"></a><a href="#" title="' + _('不满') + '"></a><a href="#" title="' + _('祈福') + '"></a></dd></dl>\
			<dl fold="cFace/d"><dt>' + _('爱心龟') + '</dt><dd><a href="#" title="' + _('懊恼') + '"></a><a href="#" title="' + _('扒鬼脸') + '"></a><a href="#" title="' + _('擦汗') + '"></a><a href="#" title="' + _('吃饭') + '"></a><a href="#" title="' + _('吃惊') + '"></a><a href="#" title="' + _('大笑') + '"></a><a href="#" title="' + _('奋斗') + '"></a><a href="#" title="' + _('归隐') + '"></a><a href="#" title="' + _('哭闹') + '"></a><a href="#" title="' + _('美女') + '"></a><a href="#" title="' + _('藐视') + '"></a><a href="#" title="' + _('上吊') + '"></a></dd></dl>\
			<dl fold="cFace/f" class="fline2"><dt>' + _('唛哩唛哩轰') + '</dt><dd><a href="#" title="' + _('吃西瓜') + '"></a><a href="#" title="' + _('感谢') + '"></a><a href="#" title="' + _('给力') + '"></a><a href="#" title="' + _('鬼脸') + '"></a><a href="#" title="' + _('哈哈') + '"></a><a href="#" title="' + _('汗') + '"></a><a href="#" title="' + _('好吃') + '"></a><a href="#" title="' + _('呼啦圈') + '"></a><a href="#" title="' + _('花痴') + '"></a><a href="#" title="' + _('哭') + '"></a><a href="#" title="' + _('忙碌') + '"></a><a href="#" title="' + _('女王') + '"></a><a href="#" title="' + _('撒花') + '"></a><a href="#" title="' + _('跳舞') + '"></a><a href="#" title="' + _('吐') + '"></a></dd></dl>\
			<dl fold="cFace/j" class="fline2"><dt>' + _('哎呦熊') + '</dt><dd><a href="#" title="' + _('吃饭') + '"></a><a href="#" title="' + _('飞吻') + '"></a><a href="#" title="' + _('浮云') + '"></a><a href="#" title="' + _('鼓掌') + '"></a><a href="#" title="' + _('害羞') + '"></a><a href="#" title="' + _('囧') + '"></a><a href="#" title="' + _('纠结') + '"></a><a href="#" title="' + _('开心') + '"></a><a href="#" title="' + _('哭泣') + '"></a><a href="#" title="' + _('晚安') + '"></a><a href="#" title="' + _('汗') + '"></a><a href="#" title="' + _('无奈') + '"></a><a href="#" title="' + _('招手') + '"></a><a href="#" title="' + _('震惊') + '"></a><a href="#" title="' + _('咒骂') + '"></a></dd></dl>\
		</div>\
	</div>\
