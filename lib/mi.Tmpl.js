...
MI.tmpl.listAll = '<%var shield=shield;D=MI.TalkList.date,API=MI.api.type?"?apiType="+MI.api.type:"";for(var i=0,n=talk.length;i<n;i++){\
		...
		numAll=numRelay+numComt;%><li id="<%=talk[i].id%>"<%if(fav){%> fav="<%=talk[i].favortimestamp%>"<%}%> <%if(shield){%> shield="<%=talk[i].shield%>"<%}%> rel="<%=talk[i].timestamp%>" <%if(talk[i].qinfo){%>wqid="<%=talk[i].qinfo.wqid%>"<%}%>>\
			...
			<div class="msgBox">\
				...
				<%var Image=talk[i].image && talk[i].image.length,Videos=talk[i].videos && talk[i].videos.length,Music=talk[i].music && talk[i].music.length,Mlist=talk[i].mlist,Vote=talk[i].vote && talk[i].vote.length;if(Image || Videos || Music || Mlist || Vote){%><div class="mediaWrap">\
					<%if(Vote || !(Image || Videos || Music || Mlist)){%>\
					...
					<div class="replyBox">\
						<div class="msgBox">\
							...
							<%}else{%>\
								...
								<%var Image='+V1+'.image && '+V1+'.image.length,Videos='+V1+'.videos && '+V1+'.videos.length,Music='+V1+'.music && '+V1+'.music.length,Mlist='+V1+'.mlist,Vote='+V1+'.vote && '+V1+'.vote.length;if(Image || Videos || Music || Mlist || Vote){%><div class="mediaWrap">\
									<%if(Vote || !(Image || Videos || Music || Mlist)){%>\
...
MI.tmpl.face = '<div class="faceWrap" style="display:none">\
	...
	<div class="faceBox">\
		<div class="faceCell">\
			...
			<div class="pFace">\
				<div><a href="#" title="' + _('红包') + '" class="f151"></a><a href="#" title="' + _('喜糖') + '" class="f150"></a><a href="#" title="' + _('百合花') + '" class="f138"></a><a href="#" title="' + _('黄丝带') + '" class="f137"></a><a href="#" title="' + _('祈福') + '" class="f136"></a><a href="#" title="' + _('黑丝带') + '" class="f135"></a></div>\
			</div>\
		</div>\
	</div>\
	<div class="faceBox" style="display:none">\
		<div class="faceCell cFace1" style="">\
			<dl fold="cFace/p" class="fline2"><dt>' + _('boto') + '</dt><dd><a href="#" title="' + _('嗨') + '"></a><a href="#" title="' + _('OK') + '"></a><a href="#" title="' + _('what？') + '"></a><a href="#" title="' + _('崩溃') + '"></a><a href="#" title="' + _('不说') + '"></a><a href="#" title="' + _('吃饭') + '"></a><a href="#" title="' + _('吃惊') + '"></a><a href="#" title="' + _('吃西瓜') + '"></a><a href="#" title="' + _('飞吻') + '"></a><a href="#" title="' + _('揪花') + '"></a><a href="#" title="' + _('泡泡糖') + '"></a><a href="#" title="' + _('忍') + '"></a><a href="#" title="' + _('生闷气') + '"></a><a href="#" title="' + _('叹气') + '"></a><a href="#" title="' + _('调皮') + '"></a><a href="#" title="' + _('偷看') + '"></a><a href="#" title="' + _('吐血') + '"></a><a href="#" title="' + _('献花') + '"></a><a href="#" title="' + _('再见') + '"></a><a href="#" title="' + _('抓狂') + '"></a><a href="#" title="' + _('拽脸蛋') + '"></a><a href="#" title="' + _('抛钱') + '" i="25"></a><a href="#" title="' + _('讥笑') + '" i="21"></a><a href="#" title="' + _('怒') + '" i="22"></a><a href="#" title="' + _('听歌') + '" i="23"></a><a href="#" title="' + _('吐槽') + '" i="24"></a></dd></dl>\
