...
MI.tmpl.face = '<div class="faceWrap" style="display:none">\
	...
	<div class="faceBox" style="display:none">\
		<div class="faceCell cFace1" style="">\
			...
			<dl fold="cFace/i" class="fline2"><dt>' + _('小幺鸡') + '</dt><dd><a href="#" title="' + _('摇晃') + '"></a><a href="#" title="' + _('欢快') + '"></a><a href="#" title="' + _('咖啡') + '"></a><a href="#" title="' + _('热身') + '"></a><a href="#" title="' + _('吓唬') + '"></a><a href="#" title="' + _('吃东西') + '"></a><a href="#" title="' + _('欢迎') + '"></a><a href="#" title="' + _('媚眼') + '"></a><a href="#" title="' + _('呕吐') + '"></a><a href="#" title="' + _('思考') + '"></a><a href="#" title="' + _('奸笑') + '"></a><a href="#" title="' + _('流汗') + '"></a><a href="#" title="' + _('旋转汗') + '"></a><a href="#" title="' + _('冒泡') + '"></a><a href="#" title="' + _('震撼') + '"></a><a href="#" title="' + _('抓沙发') + '"></a><a href="#" title="' + _('舌头') + '"></a><a href="#" title="' + _('心凉') + '"></a><a href="#" title="' + _('害怕') + '"></a><a href="#" title="' + _('流泪') + '"></a></dd></dl>\
