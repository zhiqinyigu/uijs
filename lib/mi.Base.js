 ...
 *
 */
MI.pmcompose = function(name, type)
{
	if (window.PM)
	{
		//已经加载了wbpm.js
	...
	var _sHost = location.protocol + "//pm.t.qq.com/",
		...
		_sJsUrl = [_sHost, "zh_CN/htmledition/js/", _jsName, "?version=110420"].join(""),
		_sCssUrl = _sHost + "zh_CN/htmledition/style/wbpm.css?v=110420",
		_bClose = false;
	...
	setTimeout(function()
		{
			(new Image).src = [_sHost, "cgi-bin/getinvestigate?stat=wbpm&type=1&subtype=", type || 0, '&r=', Math.random()].join('');
		},
		100
	);
