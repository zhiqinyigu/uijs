	...
	*/
	...
	if (oBanner && talkBox){
		UI.css('#homeBannerTip{position:relative;width:576px;height:129px;margin:9px 0 0 9px;background:url(' + oBanner.pic + ') 50% 50% no-repeat;overflow:hidden;}\
			...
			#homeBannerTip .close{float:none;z-index:2;position:absolute;margin:0;top:10px;right:13px}');
	...
	show : function(o, py){
		...
		//if (this.word) {
			...
			if (matchLength) {
				...
				this._body.innerHTML = '<li class="on"><span>' + match.join('</span></li><li><span>') + '</span></li>';
