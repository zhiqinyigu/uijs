...
MI.tmpl.know = '<div class="tjRelaWrap"><div class="title"><div class="left">' +_('可能认识的人') + '<a class="cSign"></a><a class="change" href="#">[' +_('换一换') +']</a><a href="http://t.qq.com/potential.php" target="_blank">[' +_('全部') + ']</a></div><div class="right"><a href="#" class="closebtn">' +_('关闭') + '</a></div></div><ul class="tjRelaList clear"><ul></div>';
...
MI.DropBox = function(opt){
	...
	this.start = opt.start; 	//是否对齐浮层起始位置，0：对齐尾部，1：对齐头部
...
MI.DropBox.prototype = {
	...
	build : function(){
		...
		Self.listBox = $$(Self.body,'.itemBox')[0];
		Self.funcBox = $$(Self.body,'.func .clear')[0];
		Self.funcBox.innerHTML = Self.add;
	...
	show : function(){
		...
		UI.show(Self.body);
		if(!Self.listData) Self.refresh(Self.html);
	},
	hide : function(){
		var Self = this;
		clearTimeout(Self.delayHide);
		...
		if(html || Self.listData) {
			...
			MI.ajax({
				...
				success : function(data){
					...
					if(data.result == 0) {
						if(data.info.list) {
							Self.refresh(data.info.list);
							Self.listData = data.info.list;
						}
					} else {
						Self.refresh('<p>' + data.msg + '</p>');
					}
				}
			})
		}
...
(function(){
	...
	UI.css('.topNav .topNavSub{position:absolute;left:0;top:35px;min-width:110px;*width:110px;background-color:#1a1a1a;-webkit-box-shadow:0 1px 2px rgba(0,0,0,0.5);-moz-box-shadow:0 1px 2px rgba(0,0,0,0.5);box-shadow:0 1px 2px rgba(0,0,0,0.5);opacity:.9;filter:alpha(opacity=90)}.topNav .apps .topNavSub{ width:220px}.topNav .topNavSub ul{ float:left;min-width:110px;*width:110px;}.topNav .topNavSub li{white-space:nowrap}.topNav .topNavSub a{float:none;padding:8px 9px 9px;font-size:12px; color:#fff}.topNav .topNavSub a:hover{background:#090909}.apps .topNavSub ul{ padding:5px 0 8px}.apps .topNavSub a{ height:16px; padding:5px 11px; color:#c9c9c9}.apps .topNavSub img{ vertical-align:middle; margin-right:5px; width:16px; height:16px}.apps .topNavSub{ width:269px}.topNav .topNavSub b{margin-left:2px;font-weight:normal;color:#f56200}.topNav .func{ clear:both; border-top:#000 1px solid; margin:0 11px}.topNav .func div{ border-top:#404141 1px solid; padding:3px 0 7px}.topNav .func a{ display:inline; padding:0}.topNav .func a:hover{ background-color:transparent!important; text-decoration:underline}');

	//应用
	var appBtn = $$(document.body,'.apps a')[0];
	var account = MI.user.account;
	if(appBtn ) var appDropBox = new MI.DropBox({
		target : appBtn,
		dir : 2,
		start : 1,
		className : 'topNavSub',
		url : null,
		add : '<p class="right"><a href="http://app.t.qq.com/" title="' + _('应用频道') + '">' + _('应用频道') + '<span class="ffsong">&gt;&gt;</span></a></p><p class="left"><a href="http://open.t.qq.com/apps/appslist.php" title="' + _('管理我的应用') + '">' + _('管理我的应用') + '</a></p>',
		html : '<ul>\
					<li><a href="http://t.qq.com/app/qzblog/' + account + '" onmousedown="MI.Bos(\'btnTopMenuAppBlog\')"><img src="http://mat1.gtimg.com/www/mb/images/appicon/blog.png">' + _('日志') + '</a></li>\
					<li' + (MI.user.fun.app == 1 ? '' : ' style="display:none"') + '><a href="http://t.qq.com/app/qzphoto/' + account + '" onmousedown="MI.Bos(\'btnTopMenuAppPhoto\')"><img src="http://mat1.gtimg.com/www/mb/images/appicon/album.png">' + _('相册') + '</a></li>\
					<li' + ((MI.user.medal && MI.user.medal[1] > 2) ? '' : ' style="display:none"') + '><a href="http://t.qq.com/app/music/' + account + '" onmousedown="MI.Bos(\'btnTopMenuAppMusic\')"><img src="http://mat1.gtimg.com/www/mb/images/appicon/vmusic.png">' + _('微音乐') + '</a></li>\
					<li><a href="http://tv.t.qq.com/index.php" target="_blank" onmousedown="MI.Bos(\'btnTopMenuAppTV\')"><img src="http://mat1.gtimg.com/www/mb/images/appicon/vtv.gif">' + _('微电视') + '</a></li>\
					<li><a href="#"><img src="http://mat1.gtimg.com/www/mb/images/appicon/blog.png">' + _('欢乐蒲公英') + '</a></li>\
				</ul>\
				<ul>\
					<li><a href="#"><img src="http://mat1.gtimg.com/www/mb/images/appicon/blog.png">' + _('欢乐蒲公英') + '</a></li>\
					<li><a href="#"><img src="http://mat1.gtimg.com/www/mb/images/appicon/blog.png">' + _('猪头看你的') + '</a></li>\
					<li><a href="#"><img src="http://mat1.gtimg.com/www/mb/images/appicon/blog.png">' + _('ZAKER') + '</a></li>\
					<li><a href="#"><img src="http://mat1.gtimg.com/www/mb/images/appicon/blog.png">' + _('开心交友') + '</a></li>\
				</ul>'
