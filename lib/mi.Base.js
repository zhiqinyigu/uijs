...
MI.navMenu = function(){ //Nav Menu
	...
	if (!nav){
		...
		var menu = {
			...
			app : UI.html('<div class="subNav"><p><a href="http://t.qq.com/app/qzblog/' + account + '" onmousedown="MI.Bos(\'btnTopMenuAppBlog\')">' + _('日志') + '</a></p><p' + (MI.user.fun.app == 1 ? '' : ' style="display:none"') + '><a href="http://t.qq.com/app/qzphoto/' + account + '" onmousedown="MI.Bos(\'btnTopMenuAppPhoto\')">' + _('相册') + '</a></p><p class="last"><a href="http://app.t.qq.com" onmousedown="MI.Bos(\'btnTopMenuAppChannel\')">' + _('应用频道') + '</a></p><p><a href="http://tv.t.qq.com/index.php" target="_blank" onmousedown="MI.Bos(\'btnTopMenuAppTV\')">' + _('微电视') + '</a></p><p class="last" style="display:none"><a href="http://open.t.qq.com/apps/appslist.php" >' + _('我的应用') + '</a></p></div>')[0],
