...
MI.navMenu = function(){ //Nav Menu
	var nav = $('nav'),
		...
		btn_timer;
	if (news){
		subNav = UI.html('<div class="subNav" onclick="MI.Bos(\'btnTopMenuNews\')"><p><a href="/p/news">大家在说</a></p><p><a href="/p/mobile">手机广播</a></p><p><a href="/p/city">同城广播</a></p><p><a href="/p/top">热门广播</a></p><p><a href="/college_anas.php">经典语录</a></p><p class="last"><a href="/dandelion.php?g">蒲公英</a></p><p><a href="/p/rank">排 行 榜</a></p><p class="last"><a href="/lists.php">名单集市</a></p></div>')[0];
