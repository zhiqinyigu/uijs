...
MI.loadPM = function(_afJsOnload)
{
	var _sHost = location.protocol + "//pm.t.qq.com/",
		...
		_sJsUrl = [_sStaticHost, "zh_CN/htmledition/js/", _jsName, "?version=110721"].join(""),
		_sCssUrl = _sStaticHost + "zh_CN/htmledition/style/wbpm.css?v=110721";
...
MI.PhotoMultiUpload = {
	...
	upload:function(){
		var Self = this;
		if(document.MultiPhoto.height >= 8190) {
			Self.setTip(_('图片总高度超过8190px，请删减 '));
			return;
		}
		MI.dialog.showLoad();
...
MI.Text2Pic = {
	html :'<div class="Text2Pic" style="padding:5px 0;text-align:center"><p style="padding-bottom:2px;color:#999;">' + _('一条微博说不完的话，转成图片试试吧。2000字以内，支持话题、帐号、URL自动提取。') + '</p><textArea class="longText" style="height:300px;width:450px;padding:10px;border:1px solid #ccc;font-size:14px;font-family:Tahoma,Arial;"></textArea><div class="flashWrap" style="height:0;position:absolute;z-index:-10;left:15px;top:10px;"></div><div class="clear"><p style="text-align:right;padding:5px 0;" class="btnBox"><span class="tip" style="position:absolute;z-index:9;display:none;padding:20px 20px 20px 40px;bottom:160px;left:150px;border:5px solid #ccc;font:18px/21px \'MicroSoft YaHei\',\'Simhei\';color:#333;background:#fff url(\'http://mat1.gtimg.com/www/mb/images/loading.gif\') no-repeat 15px 50%;"></span><button class="btn3 btnSend">' + _('确定') + '</button>&nbsp;<button class="btnCancel btn_cancel">' + _('取消') + '</button></p></div></div>',
	flashHtml :'<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="Text2Pic" width="462" height="10" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab"><param name="movie" value="http://mat1.gtimg.com/www/mb/swf/Text2Pic_110722.swf" /><param name="wmode" value="transparent" /><param name="quality" value="high" /><param name="align" value="middle" /><param name="allowScriptAccess" value="always" /> <embed src="http://mat1.gtimg.com/www/mb/swf/Text2Pic_110722.swf" quality="high" width="462" height="10"  name="Text2Pic" align="middle" play="true" loop="false" quality="high" wmode="transparent" allowScriptAccess="always" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed></object>',
    body:null,
    txt:null,
    sendBtn:null,
    cancelBtn:null,
