...
MIIcoHtml = ['<a href="/certification" target="_blank" class="vip" title="腾讯认证"></a>','<a href="http://ent.qq.com/zt2010/star2010/fans.htm" class="ico_star" title="星光达人" target="_blank"></a>'];
/*MIIcoWC = function(id){
...
(function(){
var V1='talk[i].source',V2='info.source',V3='<div class="SA"><em>◆</em><span>◆</span></div>',V5=' href="#"',V6=' onerror="MI.Pic(this,50)"',V7=' title="<%=talk[i].nick.toTitle()%>(@<%=talk[i].chName || talk[i].name%>)"';
MI.tmpl.listAll = '<%for(var i=0,n=talk.length;i<n;i++){\
		...
		numAll=numRelay+numComt;%><li id="<%=talk[i].id%>"<%if(fav){%> fav="<%=talk[i].favortimestamp%>"<%}%> rel="<%=talk[i].timestamp%>">\
			<%if(!guest){%>\
				<%if('+V1+' && (talk[i].type==4 || talk[i].type==5)){%>\
					<div class="userPic"><a href="/<%=talk[i].name%>"'+V7+' class="masPic"><img src="<%=talk[i].pic%>"'+V6+'/></a><a href="/<%='+V1+'.name%>" title="<%='+V1+'.nick.toTitle()%>(@<%='+V1+'.chName || '+V1+'.name%>)" class="cusPic"><img src="<%='+V1+'.pic%>"'+V6+'/></a></div>\
				<%}else{%>\
					<div class="userPic"><a href="/<%=talk[i].name%>"'+V7+'><img src="<%=talk[i].pic%>"'+V6+'/></a></div>\
				<%}%>\
			<%}%>\
			<div class="msgBox">\
				<div class="userName" rel="<%=talk[i].name%>"><strong><a href="/<%=talk[i].name%>"'+V7+'><%=talk[i].nick%></a>'+MIIcon('talk[i].flag')+'<%=talk[i].icon%><%if(!'+V1+'){%>:<%}%></strong><%if('+V1+' && talk[i].type==2){%>转播:&nbsp;<%}else if('+V1+' && talk[i].type==7){%>点评:&nbsp;<%}else if('+V1+' && (talk[i].type==4 || talk[i].type==5)){%>对<strong class="userTo"><a href="/<%='+V1+'.name%>" title="<%='+V1+'.nick.toTitle()%>(@<%='+V1+'.chName || '+V1+'.name%>)"><%='+V1+'.nick%></a>'+MIIcon(V1+'.flag')+'说:<%}%></strong>\
				</div>\
				...
				<%if('+V1+' && (talk[i].type==2 || talk[i].type==7)){%>\
					<div class="replyBox">\
						<div class="msgBox">\
							<div class="msgCnt"><strong><a href="/<%='+V1+'.name%>" title="<%='+V1+'.nick.toTitle()%>(@<%='+V1+'.chName || '+V1+'.name%>)"><%='+V1+'.nick%></a>'+MIIcon(V1+'.flag')+'<%='+V1+'.icon%>:</strong><%='+V1+'.content%></div>\
...
MI.tmpl.msg = '<%for(var i=0,n=talk.length;i<n;i++){%><li id="<%=talk[i].id%>" rel="<%=talk[i].timestamp%>">\
			<div class="msgBox"><div class="userName">发给 <a href="/<%=talk[i].name%>" title="<%=talk[i].nick%>(@<%=talk[i].chName || talk[i].name%>)"><%=talk[i].nick%></a>'+MIIcon('talk[i].flag')+'</div><div class="msgCnt"><%=talk[i].content%></div><div class="pubTime"><span class="time"><%=talk[i].time%></span></div><p class="btnBox"><a href="#" class="replyMsg btn" rel="<%=talk[i].chName || talk[i].name%>">再写一封</a><a class="btn delBtn" href="#">删除</a></p></div>\
		</li><%}%>';
MI.tmpl.msgIn = '<%for(var i=0,n=talk.length;i<n;i++){%><li id="<%=talk[i].id%>" rel="<%=talk[i].timestamp%>">\
			<div class="userPic"><a href="/<%=talk[i].name%>" title="<%=talk[i].nick%>(@<%=talk[i].chName || talk[i].name%>)"><img src="<%=talk[i].pic%>"></a></div>\
			<div class="msgBox"><div class="userName"><strong><a href="/<%=talk[i].name%>" title="<%=talk[i].nick%>(@<%=talk[i].chName || talk[i].name%>)"><%=talk[i].nick%></a>'+MIIcon('talk[i].flag')+':</strong></div><div class="msgCnt"><%=talk[i].content%></div><div class="pubTime"><span class="time"><%=talk[i].time%></span></div><p class="btnBox"><a href="#" class="replyMsg btn" rel="<%=talk[i].chName || talk[i].name%>">回信</a><a class="btn delBtn" href="#">删除</a></p></div>\
		</li><%}%>';
...
MI.navMenu = function(){ //Nav Menu
	var nav = $('nav'),
		...
		btn_timer;
	if (news){
		subNav = UI.html('<div class="subNav" onclick="MI.Bos(\'btnTopMenuNews\')"><p><a href="/p/news">大家在说</a></p><p><a href="/p/mobile">手机广播</a></p><p><a href="/p/city">同城广播</a></p><p><a href="/p/top">热门广播</a></p><p><a href="/college_anas.php">经典语录</a></p><p><a href="/dandelion.php?g">蒲 公 英</a></p><p><a href="/p/rank">排 行 榜</a></p><p class="last"><a href="/lists.php">名单集市</a></p></div>')[0];
		...
		if (noList) {
			...
			UI.ajax({
				...
				success : function(data){
					...
					data = MI.json(data);
					if (data.result == 0) {
						var create = data.canCreate ? '<a href="#" onclick="MI.viewListHide&&MI.viewListHide();MI.List.add();MI.Bos(\'btnListViewAdd\');return false">创建</a>|' : '',
							floatListBtn = '';
						if (isLab){
							floatListBtn = floatList ? '<div class="ldHead"><div onclick="document.location.href=document.location.pathname+\'?floatlist=0\';return false" class="goNormal" title="收起模式"><em></em>我的名单</div></div>' : '<div class="ldHead"><div onclick="document.location.href=document.location.pathname+\'?floatlist=1\';return false" class="goSide" title="悬浮模式"><em></em>悬浮模式</div></div>';
						}
						listWrap.innerHTML = '<div>' + floatListBtn + '</div><div class="ldList"><a href="#" class="ld_btn pageUp" title="向上滚动" style="display:none"><em></em></a><div class="ldListBox"><ul>' + data.info + '</ul></div><a href="#" class="ld_btn pageDown" title="向下滚动" style="display:none"><em></em></a></div><p><a href="/lists.php">集市</a>|' + create + '<a href="/list_mine.php" onclick="MI.Bos(\'btnListViewAdmin\')">管理</a></p>';
						if (keyOnly){
							show();
						}
					}
...
');
	...
	if (oMsg && talkBox){
		var idMsg = 'homeMsgTip',
			msg,
			followAll;
		msg = UI.html('<div class="newsTips1" id="' + idMsg + '"><em class="ico_ntips"></em><span class="left">' + oMsg.content + '</span><a href="#" onclick="UI.hide(\'' + idMsg + '\');UI.ajax({url:\'/asyn/updateTips.php\',data:{id:\''+oMsg.id+'\',status:0}});MI.Bos(\'btnMsg_' + oMsg.id + '\');return false" class="close" title="关闭"></a></div>')[0];
...
MI.TalkBox.prototype.addFace = function(){
	var Self = this;
	if (!Self._faceBox){
		Self._faceBox = UI.html('<div class="faceWrap" style="display:none"><a href="#" class="close" title="关闭"></a><div class="faceBox"><a href="#" class="f14" title="微笑"></a><a href="#" class="f1" title="撇嘴"></a><a href="#" class="f2" title="色"></a><a href="#" class="f3" title="发呆"></a><a href="#" class="f4" title="得意"></a><a href="#" class="f5" title="流泪"></a><a href="#" class="f6" title="害羞"></a><a href="#" class="f7" title="闭嘴"></a><a href="#" class="f8" title="睡"></a><a href="#" class="f9" title="大哭"></a><a href="#" class="f10" title="尴尬"></a><a href="#" class="f11" title="发怒"></a><a href="#" class="f12" title="调皮"></a><a href="#" class="f13" title="呲牙"></a><a href="#" class="f0" title="惊讶"></a><a href="#" class="f15" title="难过"></a><a href="#" class="f16" title="酷"></a><a href="#" class="f96" title="冷汗"></a><a href="#" class="f18" title="抓狂"></a><a href="#" class="f19" title="吐"></a><a href="#" class="f20" title="偷笑"></a><a href="#" class="f21" title="可爱"></a><a href="#" class="f22" title="白眼"></a><a href="#" class="f23" title="傲慢"></a><a href="#" class="f24" title="饥饿"></a><a href="#" class="f25" title="困"></a><a href="#" class="f26" title="惊恐"></a><a href="#" class="f27" title="流汗"></a><a href="#" class="f28" title="憨笑"></a><a href="#" class="f29" title="大兵"></a><a href="#" class="f30" title="奋斗"></a><a href="#" class="f31" title="咒骂"></a><a href="#" class="f32" title="疑问"></a><a href="#" class="f33" title="嘘"></a><a href="#" class="f34" title="晕"></a><a href="#" class="f35" title="折磨"></a><a href="#" class="f36" title="衰"></a><a href="#" class="f37" title="骷髅"></a><a href="#" class="f38" title="敲打"></a><a href="#" class="f39" title="再见"></a><a href="#" class="f97" title="擦汗"></a><a href="#" class="f98" title="抠鼻"></a><a href="#" class="f99" title="鼓掌"></a><a href="#" class="f100" title="糗大了"></a><a href="#" class="f101" title="坏笑"></a><a href="#" class="f102" title="左哼哼"></a><a href="#" class="f103" title="右哼哼"></a><a href="#" class="f104" title="哈欠"></a><a href="#" class="f105" title="鄙视"></a><a href="#" class="f106" title="委屈"></a><a href="#" class="f107" title="快哭了"></a><a href="#" class="f108" title="阴险"></a><a href="#" class="f109" title="亲亲"></a><a href="#" class="f110" title="吓"></a><a href="#" class="f111" title="可怜"></a><a href="#" class="f112" title="菜刀"></a><a href="#" class="f89" title="西瓜"></a><a href="#" class="f113" title="啤酒"></a><a href="#" class="f114" title="篮球"></a><a href="#" class="f115" title="乒乓"></a><a href="#" class="f60" title="咖啡"></a><a href="#" class="f61" title="饭"></a><a href="#" class="f46" title="猪头"></a><a href="#" class="f63" title="玫瑰"></a><a href="#" class="f64" title="凋谢"></a><a href="#" class="f116" title="示爱"></a><a href="#" class="f66" title="爱心"></a><a href="#" class="f67" title="心碎"></a><a href="#" class="f53" title="蛋糕"></a><a href="#" class="f54" title="闪电"></a><a href="#" class="f55" title="炸弹"></a><a href="#" class="f56" title="刀"></a><a href="#" class="f57" title="足球"></a><a href="#" class="f117" title="瓢虫"></a><a href="#" class="f59" title="便便"></a><a href="#" class="f75" title="月亮"></a><a href="#" class="f74" title="太阳"></a><a href="#" class="f69" title="礼物"></a><a href="#" class="f49" title="拥抱"></a><a href="#" class="f76" title="强"></a><a href="#" class="f77" title="弱"></a><a href="#" class="f78" title="握手"></a><a href="#" class="f79" title="胜利"></a><a href="#" class="f118" title="抱拳"></a><a href="#" class="f119" title="勾引"></a><a href="#" class="f120" title="拳头"></a><a href="#" class="f121" title="差劲"></a><a href="#" class="f122" title="爱你"></a><a href="#" class="f123" title="NO"></a><a href="#" class="f124" title="OK"></a><a href="#" class="f42" title="爱情"></a><a href="#" class="f85" title="飞吻"></a><a href="#" class="f43" title="跳跳"></a><a href="#" class="f41" title="发抖"></a><a href="#" class="f86" title="怄火"></a><a href="#" class="f125" title="转圈"></a><a href="#" class="f126" title="磕头"></a><a href="#" class="f127" title="回头"></a><a href="#" class="f128" title="跳绳"></a><a href="#" class="f129" title="挥手"></a><a href="#" class="f130" title="激动"></a><a href="#" class="f131" title="街舞"></a><a href="#" class="f132" title="献吻"></a><a href="#" class="f133" title="左太极"></a><a href="#" class="f134" title="右太极"></a><div class="facePreview" style="display:none"></div></div></div>')[0];
...
MI.AutoCmt.prototype = {
	...
	tips : '<div class="tips">@朋友帐号,他就能在[提到我的]页收到</div>',
		...
		if (name){
			UI.ajax({
				...
				success : function(data){
					...
					if (data.result == 0){
						data.info.name = name;
						var gender = data.info.gender ? '他' : '她';
		...
		if (data.result == 0){
			if (Self.msgTo[name] && !Self.msgTo[name].info.follow){
				MI.confirm({
					type : 'success',
					title : data.msg,
					content : '你还没有收听' + Self.msgTo[name].info.nick + '，收听后才能收到的' + Self.msgTo[name].info.gender + '回信',
					confirmTxt : '立即收听',
					cancelTxt : '以后再说',
					confirm : function(){
						MI.follow(Self.msgTo[name].info.name,UI.html('<b></b>')[0],function(isFollow){
							if (!MI.user.fun.followList) MI.tip('收听成功');
						});
						MI.Bos('btnMsgFollow');
					},
					cancel : function(){
