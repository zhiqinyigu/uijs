			...
			if (data.result == 0){
				...
				MI.dialog.show({
					...
					html : '<div class="foedSets"><table border="0" cellspacing="0" cellpadding="0"><tbody>\
						<tr><th>' + _('备注：') + '</th><td><input type="text" class="inputTxt"><div></div></td></tr>\
						<tr><th>' + _('选择名单：') + '</th><td>\
							<div class="Dlist">\
								<a href="#" onclick="UI.toggleClass(this.parentNode,\'cityDropDis\');return false" class="citySel"><em>我收听...</em>，<em>我收听...</em><span></span></a>\
							...
							<div class="DcreateList" style="display:none">\
								<form action="' + Self.url.add + '" method="post" id="listFollowForm" onsubmit="return false">\
									...
									<p>浏览权限：<label><input type="radio" class="check1" id="priv" name="priv" value="0" checked>' + _('所有人可见') + '</label><label><input type="radio" class="check1" name="priv" value="1">' + _('仅自己可见') + '</label><span></span></p>\
