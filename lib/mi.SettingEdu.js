MI.SettingEdu = {
	...
	build : function(){
		...
		Self._departmentList = UI.html('<div class="selDpmt"><div class="tmask"></div><div class="selDpmt"><div class="selListWrap"></div></div><div class="noScholl" style="display:none">暂时没有符合条件的院系</div><div class="bmask"></div></div>')[0];
	...
	citySelectDisplay : function(){
		if (this._schoolType.value < 4 && this._schoolType.value != 1){
			UI.show($('city'));
		}
		else {
			UI.hide($('city'));
