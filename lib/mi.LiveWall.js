	...
	addNewly : function(json){
		...
		if (data.result == 0 && data.info.talk.length > 0) {
			...
			newTalk.onclick = function(){
				Self.stopNewly();
				MI.dialog.show({width:960,html:this.cloneNode(true)})
