...
MI.TalkBox.prototype.addEvent = function(){ // 事件绑定
	...
	*/
	...
	Self.uploadCollection = function(o){
		...
		up.btnX = UI.getX(up._open);
		up.btnWidth = UI.width(up._open);
		...
		up.setArrPos = function(){
			...
			up._arrows.style.left = (up.btnX - x) + up.btnWidth/2 + 'px';
		}
...
MI.SearchPic = {
	...
	build : function(o){
		...
		this.PageNum = 16;
		Self.talkBox = o;
		var html = UI.html('<div class="loading" style="display:none;"></div><div class="p_searchBox clear"><form method="get"><span class="sosoLogo"><em class="ico_soso"></em>图片</span><input type="text" class="inputTxt" x-webkit-speech="x-webkit-speech" speech="speech" onwebkitspeechchange="MI.Bos(\'btnPicSearchSpeech\')" /><input type="submit" class="btn1" value="搜索"></form></div>'),frag = document.createDocumentFragment();
		UI.each(html,function(o){
			UI.append(o,frag);
		});
