...
.colorPickerPosition{position:absolute;height:0;margin:-31px 0 0 -222px}');
	...
	diy : function() { // 自定义皮肤
		...
		Self._diyImageCode = $$(Self._diyBody, '.themebgWrap form input')[1];
...
.SM .index i,.topicIntro .top,.topicIntro .middle em{display:none}\
...
.SM li.current{width:200px;height:32px;border-style:solid;border-width:1px 1px 1px 0;border-color:<%=color_5%>;background:#fff!important}.SM li.current i{display:none!important}\
.SM li:hover i,.SM li.hover i,.SM #x1:hover i,.SM #x1.hover i{left:1px;display:block;height:33px;background-position:0 -55px;_padding-top:55px;_margin-top:-55px;border-bottom:1px solid <%=color_1%>}\
