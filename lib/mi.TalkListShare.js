...
MI.tmpl.shareMsg = '<div class="shareMsg" style="display:none;width:560px;padding-top:10px;"></div>';
...
MI.TalkList.shareCollection = (function(){
	var collectionTab = '<div class="DshareWrap"><div class="tabStyle1 shareTitle"><ul><li  class="select"><a href="#">' + _('邮箱分享') + '</a></li><li><a href="#">' + _('QQ分享') + '</a></li><li><a href="#">' + _('空间分享') + '</a></li><li><a href="#">' + _('私信分享') + '</a></li></ul></div>',	
		tmpHtml = collectionTab +  MI.tmpl.shareMail + MI.tmpl.shareQQ + MI.tmpl.shareQzone  +  MI.tmpl.shareMsg + '</div>',
		...
		tabArray = ['shareMail','shareQQ','shareQzone','shareMsg'],  //和tab对应
		boxArray = [mailBox,qqBox,qZoneBox,msgBox],  	//和tab对应
