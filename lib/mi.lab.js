			...
			*/
			...
			if (Self._video) {
				...
				*/
				...
				var html = UI.html('<div class="vloadWrap" style="display:none"><form name="videoUploadFrom" id="videoUploadFrom" class="videoUploadFrom" method="get"><a href="#" class="close" title="' + _('关闭') + '">' + _('关闭') + '</a><p>' + _('粘帖视频播放页地址') + '<br><span class="cNote">(' + _('优酷、土豆、56等网站视频可直接播放') + ')</span></p><p class="clear"><input type="text" class="inputTxt" /><input type="submit" class="btn" value="' + _('确定') + '" /></p></form><p class="cError" style="display:none">'+Self._errMsg[3]+'</p>' + (MI.user.isLab ? '<p style="display:none"><a href="#" class="ulink">' + _('我要自己上传视频') + '<em class="ffsong">&gt;&gt;</em></a></p>' : '') + '</div>')[0];
