...
MI.TalkList = function(id){ //Talk List
	...
	Self._relayList = UI.html('<div class="relayList"><div class="top"><span class="left"><a href="#" class="vClose"><em></em>收起</a></span><a href="#" class="close">关闭</a></div><div class="loading">正在加载...</div><div class="cont"></div></div>')[0];
...
MI.TalkList.prototype = {
	...
	addEvent : function(el){
		...
		if (viewRelay && viewRelay.innerHTML.hasString('点评')) { //View Relay List
