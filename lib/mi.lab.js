	...
	tmpl : {
		...
		reply : '<div class="talkWrap"><div class="SA"><em>◆</em><span>◆</span></div>\
			...
			<div class="bot">\
				...
				<div class="left" style="margin-right:1ex"></div><div class="left"></div>\
				<input type="button" class="inputBtn sendBtn" value="" /><span class="countTxt"></span>\
			</div>\
	...
	reply : function(id,type,number){ //type : 0(reply) 1(relay) 2(comt)
		...
		if (!Self.talkBox.display) {
			...
			if (replyBox && name2 && (type == 1 || type == 2)) { //添加转播评论
				this.talkBox._addReply.innerHTML = ' [<a href="#" title="' + _('你可以通过“清空点评”来去掉前面人的点评') + '">' + _('清空点评') + '</a>]';
