...
MI.Bos = function(op,value){ //Boss Using : MI.Bos('frontClick');
	try{
		...
		MI.Bos.pic[UI.random(0,9)].src = 'http://btrace.qq.com/collect?r=' + MI.random() + '&sIp=&iQQ=' + ouin + '&sBiz=microblog&sOp=' + op + '&iSta=0&iTy=214&iFlow=0' + data;
	}catch(e){}
}
MI.Uin = function(){
