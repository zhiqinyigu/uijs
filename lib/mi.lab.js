	...
	tmpl : {
		listAll : '<%for(var i=0,n=talk.length;i<n;i++){%><li id="<%=talk[i].id%>"<%if(fav){%> fav="<%=talk[i].favortimestamp%>"<%}%> rel="<%=talk[i].timestamp%>">\
			...
			<div class="msgBox">\
				...
				<%if(talk[i].image && talk[i].image.length){%>\
					<div class="picWrap">\
				...
				<%if('+V1+' && talk[i].type==2){%>\
					<div class="replyBox">\
						<div class="msgBox">\
							...
							<%}%>\
							<div class="pubInfo"><span class="left"><a class="time" rel="<%='+V1+'.timestamp%>" href="/p/t/<%='+V1+'.id%>" target="_blank"><%='+V1+'.time%></a> <%='+V1+'.from%><%if('+V1+' && '+V1+'.count){if(MI.user.account){%>\
				...
				<%}%>\
				<%if(talk[i].videos && talk[i].videos.length){%>\
					<div class="videoWrap">\
				...
				<%}%>\
				<div class="pubInfo"><span class="left"><a class="time" href="/p/t/<%=talk[i].id%>" target="_blank"><%=talk[i].time%></a> <%=talk[i].from%><%if(talk[i].count){if(MI.user.account){%>\
