...
MI.TalkList.prototype = {
	...
	card : function(){
		...
		UI.each($$(Self._body,'.userPic img'),function(o){
			if (!UI.A(o,'card')) {
				...
				UI.EA(o,'touchmove',MI.Card.show);
	...
	addEvent : function(el){
		...
		if (view) {
			view.onmouseover = view.ontouchmove = function(){
...
MI.Card = function(){ //Info Card
	...
	Self._black.onclick = function(){
		...
		o.call = function(){
			...
			obj.block = UI.hasClass(Self._black,'blackDel');
		};
		MI.black(o);
		return false;
	}
...
UI.ready(function(){
	...
	setTimeout(function(){
		...
		if (MI.talkList && MI.talkList.auto) { //区分非主人页，非主人页不需要该功能
