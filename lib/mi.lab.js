...
MI_icon = function(obj){
	return '<%for(var k=0,num=MIIco.length;k<num;k++){if('+obj+'[MIIco[k]]){%><%=MIIcoHtml[k]%><%;break;}}%>';
}
MI = {
	...
	tmpl : {
		...
		card : '<div class="uCard"><div class="tip">这是你自己</div><div class="userPic"><a></a><p class="btn"><input type="button" class="addAttention" value="" /><a href="#" class="delAttention" title="取消收听">取消</a></p></div><div class="uCardcnt"><p class="userName"></p><p class="nums loading"></p><p class="btn"><a href="#" class="reply">对话</a><a href="#" class="msg">私信</a><a href="#" class="black">拉黑</a></p></div></div>'
	},
...
MI.Card.prototype = {
	...
	show : function(el){
		...
		function show(o){
			var num = o.num,notSelf = Self.account != MI.user.account,btn = o.follow ? Self._unfollow : Self._follow,icon = '',gender = o.flag.gender ? '他' : '她';
			if (o.block) {
