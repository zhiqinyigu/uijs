...
/*
	...
	college:
		...
		btnCollegeView 新手到广播学院看看
		btnCollegeViewClose 关闭新手到广播学院看看
	...
	tag:
		...
		btnTagTalk 把标签告诉大家
		btnTagGoTopic_1 - btnTagGoTopic_20 推荐订阅标签相关话题
		btnTagFollow 收听通道中人
		btnTagUnFollow 取消收听通道中人
		
		btnTagCardFollow 资料卡片收听同道中人
		btnTagFollowReply 收听通道中人发对话
		btnTagCardFollowReply 收听通道中人发对话（资料卡片）
		btnTagFollowReplySet 收听通道中人发对话（设置）
		btnTagFollowReplyYes 收听通道中人发对话（是）
		btnTagFollowReplyNo 收听通道中人发对话（否）
...
MIIcoHtml = ['<a href="/certification" target="_blank" class="vip" title="腾讯认证"></a>','<a href="http://blog.qq.com/zt/2010/2010expo/shibovol.htm" title="2010上海世博志愿者" target="_blank" class="ico_expo"></a>','<a href="http://ent.qq.com/zt2010/star2010/index.htm" class="ico_star" title="星光达人" target="_blank"></a>'];
/*MIIcoWC = function(id){
...
MI = {
	...
	appLoad : function(){
		...
		for (var i in MI._app) {
			if (!MI[i] && !MI._appLoading[i]) {
				alert(i);
				UI.getScript(MI.version[i],function(){
					if (MI._app[i]) {
						MI._app[i]();
					}
					UI.each(MI._appLoad[i],function(o){
						o();
					});
					delete MI._app[i];
				});
...
MI.Bos = function(op,value){ //Boss Using : MI.Bos('frontClick');
	try{
		...
		MI.Bos.pic[UI.random(0,9)].src = 'http://btrace.qq.com/collect?sIp=&iQQ=' + ouin + '&sBiz=microblog&sOp=' + op + '&iSta=0&iTy=214&iFlow=0' + data;
	}catch(e){}
}
MI.Uin = function(){
	...
	if (this._body) {
		...
		UI.ready(function(){
			...
			if (Self._pic) {
				...
				*/
				var html = UI.html('<p class="cutBox" style="display:none;"><span class="ico_cut"></span><a href="#" class="txt mOut">截屏</a></p><span class="pidLoad" style="display:none">上传中 <a href="#" class="cancel">[取消]</a></span><span style="display:none" class="preview"><span class="link"></span><a href="#" class="del">[删除]</a></span><iframe id="imageUpload" name="imageUpload" src="about:blank" style="display:none"></iframe>'),
