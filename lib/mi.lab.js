...
MI.Tips.prototype = {
	...
	build : function(o){
		...
		UI.each($$(o.area,o.target),function(el){
			UI.EA(el,'mouseover',mouseover);
			UI.EA(el,'mouseout',mouseout);
		});
	},
	show : function(target,txt){
		...
		Self._body.style.cssText = 'top:' + ( UI.getY(target) + UI.width(target) + 10 ) + 'px;left:' + ( UI.getX(target) - 20 ) + 'px';
		UI.show(Self._body);
	},
	hide : function(){
		UI.hide(this._body);
...
MI.Tips.txt = ['这条消息来自手机微博。<br>想要成为微博手机达人？点<a href="/client.php?t=mobile" target="_blank">这里</a>'];
...
MI.TalkList = function(id){ //Talk List
	...
	Self._relayList = UI.html('<div class="relayList"><div class="top"><span class="left">共<span class="relayNum">-</span>条 <a href="#" target="_blank">查看全部&gt;&gt;</a></span><a href="#" class="close">关闭</a></div><div class="loading">正在加载...</div><div class="cont"></div></div>')[0];
	...
	Self._relayListCont.ondblclick = function(e){ //Auto Go Next Page When Double Click
	...
	Self._relayList.onclick = function(e){
		UI.E(e).stop();
	}
	UI.ready(function(){
		...
		if (viewRelay && viewRelay.innerHTML.hasString('转播')) { //View Relay List
			...
			viewRelay.onclick = function(e){
				...
				if (list.display && Self.current == li) {
					...
					$$(list,'.left a')[0].href = href;
					$$(list,'.relayNum')[0].innerHTML = $$(this,'.relayNum')[0].innerHTML;
