...
MI.Music = {
	...
	addPreview : function(o,fav,isRecord){
		//music{song_id,songurl,singer_name,song_name}
		var Self = this;
		var prview = '<div class="sendThumbs uploadMusic"><span class="preview"><span class="link"><em class="sico ico_audio"></em><a class="fileName" href="#"><span class="m_name">%song_name%</span><b class="m_Intro">%song_fullname%<span> - %singer_name%</span></b></a></span><a class="del" href="#" title="' + _('删除') + '">[' + _('删除') + ']</a></span></div>';
...
//IE will auto start after setProcess
      ...
      listenall: function() {
        ...
        UI.each(
          $$('#talkList .songInfo'), function(e) {
            arr.push(_('[{0},{1},"{2}","{3}","","{4}","","",""]',
              UI.A(e,'songid'), UI.A(e,'songtype'), UI.A(e,'songurl'),
        ...
        var html = 
          '<form id="the-form-to-post" method="post" accept-charset="gbk" ' +
          'action="http://qzone-music.qq.com/fcg-bin/player.fcg" target="_blank">' +
      ...
      listenrecommanded: function() {
        /* YoungCat code here */
        var arr = [];
        var imgs = $$('.listenerList ul li a img');
...
//prevent auto jump to next with _progressSetted
    ...
    genRecommandWall: function(usersArray) {
      ...
      listitems.splice(22, 0, emptyli, emptyli, emptyli);
