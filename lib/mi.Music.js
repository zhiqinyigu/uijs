	...
	addPreview : function(o,fav){
		...
		UI.ajax({
			...
			success : function(data){
				data = MI.json(data);
				Self.talkBox.txtMusic = '#分享音乐# ' + m[3].replace(/\&quot;/gi,'"') + '-' + m[2].replace(/\&quot;/gi,'"') + ' http://url.cn/' + data.url+' ';
