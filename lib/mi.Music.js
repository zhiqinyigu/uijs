	...
	addPreview : function(o){
		...
		UI.ajax({
			...
			success : function(data){
				data = MI.json(data);
				Self.txtMusic = '#分享音乐# ' + m[3] + '-' + m[2] + ' http://url.cn/' + data.url;
