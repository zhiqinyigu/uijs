...
window.onload = function() {
  ...
  if (typeof dp != 'undefined')
	...
	var example = document.getElementsByTagName('textarea');
	for (var i = 0,n = example.length;i < n;i++) {
		example[i].style.cssText = 'height:' + example[i].scrollHeight + 'px;'
		if (example[i].innerHTML=='') {
