/**
 * UI.ColorPicker Author : xhlv@tencent.com Datetime : 2010-12-16 Last Eidt:
 */
(function() {
	/**
	 * UI.ColorPicker 取色控件
	...
	UI.ColorPicker = {
		 ...
		 * HTML模版
		 * 
		 * @type {String} UI.ColorPicker.tmpl = '';
		 */
		...
		build : function() {
			...
			UI.drag(Self._box, {
				...
				drag : function(e) {
					var E = UI.E(e), Top = top + E.y - y, Left = left + E.x - x;
		 ...
		 *            Object 显示参数
		 *            @example
		 *            <a href="#" onclick="var T=this;UI.ColorPicker.show(event,{call:function(value){UI.C(T,'background',value)}});return false" style="background:#FF6699"></a>
		 */
