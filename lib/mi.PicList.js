...
MI.PicList.prototype._mapClick = {
  ...
  mail : function (el) {
    MI.PicList.shareMail(this.activeTweet);
  },
  qq : function () {
 ...
 * php中消息type含义： 1:原创发表, 2:转载, 3:私信, 4:回复, 5:空回, 6:提及, 7:评论
 */
MI.PicList.prototype._showBox = function (id, type) {
  var title, content,
    box = new MI.Reply(),
    talkBox = box.talkBox,
...
MI.PicList.prototype._getFunbox = (function () {
  ...
  t1 = '<div class="funBox"><a href="#" class="clk-relay">' + _('转播') +
    '</a><span>|</span><a href="#" class="clk-reply">' + _('对话') +
    '</a><span>|</span><div class="mFun"><a href="#" class="clk-mo-more">' +
    _('更多') + '<em class="btn_ldrop"></em></a><div class="mFunDrop clk-mo-morectn"><b></b><b class="mask"></b><p><a href="/p/t/';
  t2 = '" class="clk-comment">评论</a></p><p><a href="#" class="clk-fav">' +
    _('收藏') + '</a></p><div class="shareBtn"><p><a href="#" class="clk-mail">' +
    _('邮件分享') + '</a></p><p><a href="#" class="clk-qq">' + _('QQ分享') +
    '</a></p></div><p><a href="/p/t/';
  t3 = '" class="clk-detail" target="_blank">' + _('详情') +
    '</a></p><p><a href="#" class="clk-report">' + _('举报') +
    '</a></p></div></div></div></div>';

  return function (tid) {
    return UI.html(t1 + tid + t2 + tid + t3)[0];
  };
}());
...
MI.app({
  Base : function () {
    MI.PicList.shareQQ = MI.TalkList.prototype.shareQQ;
    MI.PicList.shareMail = MI.TalkList.prototype.shareMail;
