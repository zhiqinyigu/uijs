...
MI.PicList.prototype._mapClick = {
  ...
  share : function (el) {
    MI.user.isLab ? MI.TalkList.shareCollection.show(this.activeTweet) :
...
MI.PicList.prototype.expand = function () {
  var picDiv = this._container.firstChild.getElementsByTagName('div')[0], 
    ...
    delta = 10,
    to = this._imgH,
    animCount = Math.ceil(Math.abs((to - 300) / delta)),
...
MI.PicList.prototype._enableExpand = function (bShow) {
  ...
  bShow = bShow && this._imgH > 300 && !this._expanded;

  UI.C(btn, 'visibility', bShow ? 'visible' : 'hidden');
};
...
MI.PicList.prototype._getFunbox = (function () {
  ...
  t3 = '</p><p><a href="#" class="clk-fav">' + _('收藏') +
    ...
    (MI.user.isLab ?  _('分享') :
      _('邮件分享') +
      '</a></p><p><a href="#" class="clk-qq">' + _('QQ分享')
    ) +
