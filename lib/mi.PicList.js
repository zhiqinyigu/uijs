...
MI.app({
  ...
  <div class="imgView" id="<%=o.id%>" rel="<%=o.timestamp%>"<%=hotstyle%>>\
    ...
    <a href="/p/t/<%=o.id%>" target="_blank" class="clk-1"><img src="<%=imgo.image[0]%>/160" alt="" target="_blank" onclick="" resizeto="fitfill,120x120;max,999x999"' + (MI.Crs.onLoadResize ? ' onload="MI.Crs.onLoadResize(this)"' : '') +' /></a>\
