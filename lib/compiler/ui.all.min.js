...
var UI={ajax:function(){},get:function(a,b,c){if(window.ActiveXObject)var g=new ActiveXObject("Microsoft.XMLHTTP");else if(window.XMLHttpRequest)g=new XMLHttpRequest;g.onreadystatechange=function(){if(g.readyState==4)c(g.responseText);else return false};if(b!=undefined)a+="?"+b;g.open("GET",a,true);g.send(null)},getScript:function(a,b){var c=UI.DC("script");if(b)if(UI.B.ie)c.onreadystatechange=function(){if(c.readyState=="loaded"||c.readyState=="complete")b()};else c.onload=b;UI.A(c,"type","text/javascript");
UI.A(c,"src",a);UI.GT(document,"head")[0].appendChild(c)},getCss:function(a,b){var c=UI.DC("link");if(b)c.onload=b;UI.A(c,"rel","stylesheet");UI.A(c,"type","text/css");UI.A(c,"href",a);UI.GT(document,"head")[0].appendChild(c)},evalScript:function(a){var b=this.regExp.script;a=a.match(new RegExp(b,"img"));UI.each(a,function(c){eval(c.match(new RegExp(b,"im"))[1])})},regExp:{script:"<script[^>]*>([\\S\\s]*?)<\/script>"},url:{encode:function(a){return escape(this._utf8_encode(a))},decode:function(a){return this._utf8_decode(unescape(a))},
_utf8_encode:function(a){a=a.replace(/\r\n/g,"\n");for(var b="",c=0;c<a.length;c++){var g=a.charCodeAt(c);if(g<128)b+=String.fromCharCode(g);else{if(g>127&&g<2048)b+=String.fromCharCode(g>>6|192);else{b+=String.fromCharCode(g>>12|224);b+=String.fromCharCode(g>>6&63|128)}b+=String.fromCharCode(g&63|128)}}return b},_utf8_decode:function(a){for(var b="",c=0,g=c1=c2=0;c<a.length;){g=a.charCodeAt(c);if(g<128){b+=String.fromCharCode(g);c++}else if(g>191&&g<224){c2=a.charCodeAt(c+1);b+=String.fromCharCode((g&
31)<<6|c2&63);c+=2}else{c2=a.charCodeAt(c+1);c3=a.charCodeAt(c+2);b+=String.fromCharCode((g&15)<<12|(c2&63)<<6|c3&63);c+=3}}return b}},parseUrl:function(){var a=document.location.href,b={};if(!a.hasString("?"))return b;a=a.split("?")[1].split("&");for(var c=0;c<a.length;c++){var g=a[c].split("=");b[g[0]]=UI.B.ie?g[1]:UI.url.decode(g[1])}return b},cookie:function(a,b,c){if(b==undefined){a=a+"=";b=document.cookie.split(";");for(c=0;c<b.length;c++){for(var g=b[c];g.charAt(0)==" ";)g=g.substring(1,g.length);
if(g.indexOf(a)==0)return decodeURIComponent(g.substring(a.length,g.length))}return null}else{g="";if(c){g=new Date;g.setTime(g.getTime()+c*24*60*60*1000);g="; expires="+g.toGMTString()}document.cookie=a+"="+b+g+"; path=/"}},drag:function(a,b,c){var g=document;c=c!=undefined?c:true;UI.EA(a,"mousedown",function(o){b.start&&b.start(o);if(c)if(a.setCapture)a.setCapture();else window.captureEvents&&window.captureEvents(Event.MOUSEMOVE|Event.MOUSEUP);if(b.drag)g.onmousemove=b.drag;g.onmouseup=function(){if(c)if(a.releaseCapture)a.releaseCapture();
else window.captureEvents&&window.captureEvents(Event.MOUSEMOVE|Event.MOUSEUP);b.stop&&b.stop(o);g.onmousemove=null;g.onmouseup=null;b.call&&b.call(o)}})},animate:function(a,b,c,g){var o=setInterval(function(){var m=UI.C(a,b);if(b=="opacity"){m*=100;c*=100}else m=m=="auto"?0:Number(m.slice(0,-2));if(Math.abs(c-m)<3){m=c;clearInterval(o);eval(g)}UI.C(a,b,b!="opacity"?m+(c-m)*0.4+"px":(m+(c-m)*0.4)/100+"")},40);return o},getX:function(a){return a.offsetParent?a.offsetLeft+UI.getX(a.offsetParent):a.offsetLeft},
getY:function(a){return a.offsetParent?a.offsetTop+UI.getY(a.offsetParent):a.offsetTop},within:function(a,b){var c=UI.getX(b)-UI.scrollX(),g=UI.width(b)+c,o=UI.getY(b)-UI.scrollY();b=UI.height(b)+o;var m={};if(a[0]>c&&a[0]<g&&a[1]>o&&a[1]<b){if(a[0]-c<(g-c)/2)m.left=true;if(a[1]-o<(b-o)/2)m.top=true;return m}},frameX:function(a){return a.frameElement?UI.getX(a.frameElement)+UI.frameX(a.parent):0},frameY:function(a){return a.frameElement?UI.getY(a.frameElement)+UI.frameY(a.parent):0},width:function(a){return parseInt(a.offsetWidth)},
height:function(a){return parseInt(a.offsetHeight)},pageWidth:function(){return document.body.scrollWidth||document.documentElement.scrollWidth},pageHeight:function(){return document.body.scrollHeight||document.documentElement.scrollHeight},windowWidth:function(){var a=document.documentElement;return self.innerWidth||a&&a.clientWidth||document.body.clientWidth},windowHeight:function(){var a=document.documentElement;return self.innerHeight||a&&a.clientHeight||document.body.clientHeight},scrollX:function(a){var b=
document.documentElement;if(a){var c=a.parentNode,g=a.scrollLeft||0;if(a==b)g=UI.scrollX();return c?g+UI.scrollX(c):g}return self.pageXOffset||b&&b.scrollLeft||document.body.scrollLeft},scrollY:function(a){var b=document.documentElement;if(a){var c=a.parentNode,g=a.scrollTop||0;if(a==b)g=UI.scrollY();return c?g+UI.scrollY(c):g}return self.pageYOffset||b&&b.scrollTop||document.body.scrollTop},scrollTo:function(a,b,c){if(a==document.documentElement||a==document.body)return window.scrollTo(b,c)},hide:function(a){if(!a)return false;
if(UI.isString(a))a=this.G(a);var b=this.C(a,"display");if(b!="none")a.__curDisplay=b;a.style.display="none"},show:function(a){if(!a)return false;if(UI.isString(a))a=this.G(a);a.style.display=a.__curDisplay||""},toggle:function(a){if(UI.isString(a))a=this.G(a);this.C(a,"display")=="none"?this.show(a):this.hide(a)},hasClass:function(a,b){if(!a.className)return false;return a.className!=a.className.replace(new RegExp("\\b"+b+"\\b"),"")},addClass:function(a,b){if(a.className)if(this.hasClass(a,b))return false;
else a.className+=" "+b;else a.className=b},removeClass:function(a,b){a.className=a.className.replace(new RegExp("\\b"+b+"\\b"),"")},toggleClass:function(a,b){this.hasClass(a,b)?this.removeClass(a,b):this.addClass(a,b)},node:{ELEMENT:1,ATTRIBUTE:2,TEXT:3,CDATA_SECTION:4,ENTITY:6,COMMENT:8,DOCUMENT:9,DOCUMENT_TYPE:10},next:function(a){a=a.nextSibling;if(a==null)return false;return UI.isElement(a)?a:this.next(a)},prev:function(a){a=a.previousSibling;if(a==null)return false;return UI.isElement(a)?a:
this.prev(a)},append:function(a,b){b.appendChild(a)},prepend:function(a,b){var c=b.firstChild;c?UI.before(a,c):UI.append(a,b)},after:function(a,b){var c=b.parentNode;c.lastChild==a?c.appendChild(a):c.insertBefore(a,b.nextSibling)},before:function(a,b){b.parentNode.insertBefore(a,b)},replace:function(a,b){var c=b.parentNode;c.replaceChild(a,b)},swap:function(){},wrap:function(a,b){if(UI.isString(a)){a.match(/(<[^\/][^<]*>)/g);var c="wrapObject___",g=RegExp.lastMatch;a=a.replace(g,g+'<pre class="'+
c+'"></pre>');a=UI.html(a)[0];UI.before(a,b);UI.replace(b,UI.GC(a,"pre."+c)[0])}else{UI.before(a,b);b.appendChild(b)}},html:function(a){var b=UI.DC("div"),c=[];b.innerHTML=a;UI.each(b.childNodes,function(g){c.push(g)});return c},text:function a(b){var c=[];b=b.childNodes;for(var g=0,o=b.length;g<o;g++)c.push(b[g].nodeType!=1?b[g].nodeValue:a(b[g]));return c.join("")},parent:function(a,b){if(UI.isArray(a)){var c=[];UI.each(a,function(g){if(b&&UI.hasClass(g.parentNode,b)||!b)c.push(g.parentNode)});
return c}return a.parentNode},parents:function(a,b){if(b){var c=[];a=UI.parents(a);UI.each(a,function(g){UI.hasClass(g,b)&&c.push(g)});return c}a=a.parentNode;return a.nodeName=="HTML"?[a]:[a].concat(UI.parents(a))},children:function(a,b){var c=[];if(b)b=b.split("|");UI.each(a.childNodes,function(g){var o=false;if(b)for(var m=0,f=b.length;m<f;m++)if(UI.hasClass(g,b[m])){o=true;break}if(UI.isElement(g)&&(!b||o))c.push(g)});return c},A:function(a,b,c){if(c==undefined)return a.getAttribute(b);else a.setAttribute(b,
c)},C:function(a,b,c){if(c==undefined)if(a.currentStyle){if(b=="opacity")return a.style.filter.indexOf("opacity=")>=0?parseFloat(a.style.filter.match(/opacity=([^)]*)/)[1])/100:"1";return a.currentStyle[b]}else{if(window.getComputedStyle){b=b.replace(/([A-Z])/g,"-$1");b=b.toLowerCase();return window.getComputedStyle(a,null).getPropertyValue(b)}}else if(b=="opacity"&&UI.B.ie)a.style.filter=(a.filter||"").replace(/alpha\([^)]*\)/,"")+"alpha(opacity="+c*100+")";else a.style[b]=c},DC:function(a){return document.createElement(a)},
E:function(a){if(a&&a.clone)return a;a=window.event||a;return{clone:true,stop:function(){if(a&&a.stopPropagation)a.stopPropagation();else a.cancelBubble=true},prevent:function(){if(a&&a.preventDefault)a.preventDefault();else a.returnValue=false},target:a.target||a.srcElement,x:a.clientX||a.pageX,y:a.clientY||a.pageY,button:a.button,key:a.keyCode,shift:a.shiftKey,alt:a.altKey,ctrl:a.ctrlKey,type:a.type}},EA:function(a,b,c,g){if(UI.isString(a)){var o=c;c=function(){eval(o)}}if(a.addEventListener){a.addEventListener(b,
c,g);return true}else if(a.attachEvent)return a=a.attachEvent("on"+b,c);else return false},ER:function(a,b,c){if(a.removeEventListener){a.removeEventListener(b,c,false);return true}else if(a.detachEvent)return a=a.detachEvent("on"+b,c);else return false},ET:function(a){return a.target||a.srcElement},G:function(a){return document.getElementById(a)},GT:function(a,b){return a.getElementsByTagName(b)},GC:function(){var a=/(?:[\w\-\\.#]+)+(?:\[\w+?=([\'"])?(?:\\\1|.)+?\1\])?|\*|>/ig,b=/^(?:[\w\-_]+)?\.([\w\-_]+)/,
c=/^(?:[\w\-_]+)?#([\w\-_]+)/,g=/^([\w\*\-_]+)/,o=[null,null];function m(h,k){if(!k){k=h;h=document}h=h||document;var n=/^[\w\-_#]+$/.test(k);if(!n&&h.querySelectorAll)return f(h.querySelectorAll(k));if(k.indexOf(",")>-1){k=k.split(/,/g);n=[];for(var e=0,j=k.length;e<j;++e)n=n.concat(m(k[e],h));return p(n)}k=k.match(a);j=k.pop();n=(j.match(c)||o)[1];e=!n&&(j.match(b)||o)[1];j=!n&&(j.match(g)||o)[1];if(e&&!j&&h.getElementsByClassName)j=f(h.getElementsByClassName(e));else{j=!n&&f(h.getElementsByTagName(j||
"*"));if(e)j=i(j,"className",RegExp("(^|\\s)"+e+"(\\s|$)"));if(n)return(h=h.getElementById(n))?[h]:[]}return k[0]&&j[0]?l(k,j):j}function f(h){try{return Array.prototype.slice.call(h)}catch(k){for(var n=[],e=0,j=h.length;e<j;++e)n[e]=h[e];return n}}function l(h,k,n){var e=h.pop();if(e===">")return l(h,k,true);var j=[],q=-1,r=(e.match(c)||o)[1],t=!r&&(e.match(b)||o)[1];e=!r&&(e.match(g)||o)[1];var w=-1,v,y,x;for(e=e&&e.toLowerCase();v=k[++w];){y=v.parentNode;do{x=(x=(x=!e||e==="*"||e===y.nodeName.toLowerCase())&&
(!r||y.id===r))&&(!t||RegExp("(^|\\s)"+t+"(\\s|$)").test(y.className));if(n||x)break}while(y=y.parentNode);if(x)j[++q]=v}return h[0]&&j[0]?l(h,j):j}var p=function(){var h=+new Date,k=function(){var n=1;return function(e){var j=e[h],q=n++;if(!j){e[h]=q;return true}return false}}();return function(n){for(var e=n.length,j=[],q=-1,r=0,t;r<e;++r){t=n[r];if(k(t))j[++q]=t}h+=1;return j}}();function i(h,k,n){for(var e=-1,j,q=-1,r=[];j=h[++e];)if(n.test(j[k]))r[++q]=j;return r}return m}(),isDate:function(a){if(!a)return a;
if(a.getTime&&a.getFullYear&&a.getTimezoneOffset&&a!="NaN"&&a!="Invalid Date")return true},cloneDate:function(a){if(!a)return a;d=new Date;d.setTime(a.getTime());return d},formatDate:function(a,b){var c=b.replace(/\W/g,",").split(","),g=["yyyy","MM","dd","hh","mm","ss","ww"];a={y:a.getFullYear(),M:a.getMonth()+1,d:a.getDate(),h:a.getHours(),m:a.getMinutes(),s:a.getSeconds(),w:a.getDay()};for(var o=0,m=c.length;o<m;o++)for(var f=c[o],l=0;l<7;l++){var p=g[l].slice(-1);if(f.hasString(p)){if(p=="w"&&
a[p]==0)a[p]=7;b=f.hasString(g[l])?b.replace(RegExp(g[l],"g"),this.addZero(a[p])):b.replace(RegExp(g[l].slice(g[l].length/2),"g"),a[p])}}return b},parseDate:function(a,b){b||(b="yyyy-MM-dd");b=b.replace(/\W/g,",").split(",");a=a.replace(/\D/g,",").split(",");var c=2000,g=0,o=1,m=0,f=0,l=0,p=true;UI.each(b,function(i,h){if(a[h]==""||isNaN(a[h]))p=false;if(i.hasString("y"))c=Number(a[h]);if(i.hasString("M"))g=Number(a[h])-1;if(i.hasString("d"))o=Number(a[h]);if(i.hasString("h"))m=Number(a[h]);if(i.hasString("m"))f=
Number(a[h]);if(i.hasString("s"))l=Number(a[h]);if(i.hasString("w"))l=Number(a[h])});if(!p)return false;return new Date(c,g,o,m,f,l)},isArray:function(a){return a!==null&&UI.isObject(a)&&"splice"in a&&"join"in a},isElement:function(a){return a&&a.nodeType==1},isFunction:function(a){return typeof a=="function"},isNumber:function(a){return typeof a=="number"},isObject:function(a){return typeof a=="object"},isString:function(a){return typeof a=="string"},isUndefined:function(a){return typeof a=="undefined"},
addZero:function(a,b){var c=[],g=String(a).length;b||(b=2);if(g<b)for(var o=0;o<b-g;o++)c.push(0);c.push(a);return c.join("")},trim:function(a){return a.replace(/^\s+|\s+$/g,"")},random:function(a,b){if(a==undefined)a=0;if(b==undefined)b=9;return Math.floor(Math.random()*(b-a+1)+a)},has:function(a,b){for(var c=0,g=a.length;c<g;c++)if(a[c]==b)return true;return false},each:function(a,b){if(UI.isUndefined(a[0]))for(var c in a)UI.isFunction(a[c])||b(c,a[c]);else{c=0;for(var g=a.length;c<g;c++)UI.isFunction(a[c])||
b(a[c],c)}},map:function(a,b){if(UI.isString(b))b=eval("(function(a,i) { return "+b+"})");var c=[];UI.each(a,function(g,o){g=b(g,o);if(UI.isArray(g))c=c.concat(g);else c.push(g)});return c},grep:function(a,b){if(UI.isString(b))b=eval("(function(a,i) { return "+b+"})");var c=[];UI.each(a,function(g,o){b(g,o)&&c.push(g)});return c},merge:function(a,b){var c=[];if(b){UI.each(b,function(g){UI.has(a,g)||c.push(g)});return a.concat(c)}else{UI.each(a,function(g){UI.has(c,g)||c.push(g)});return c}},apart:function(a,
b){var c=[];UI.each(a,function(g){UI.has(b,g)||c.push(g)});return c},sort:{number:function(a,b){return a-b},numberDesc:function(a,b){return b-a},string:function(a,b){return a.localeCompare(b)},stringDesc:function(a,b){return b.localeCompare(a)}},ready:function(a){if(UI.ready.done)return a();if(UI.ready.timer)UI.ready.ready.push(a);else{UI.ready.ready=[a];UI.ready.timer=setInterval(UI.isReady,13)}},isReady:function(){if(UI.ready.done)return false;if(document&&document.getElementsByTagName&&document.getElementById&&
document.body){clearInterval(UI.ready.timer);UI.ready.timer=null;for(var a=0;a<UI.ready.ready.length;a++)UI.ready.ready[a]();UI.ready.ready=null;UI.ready.done=true}},Browser:function(){var a={},b=navigator.userAgent;a.ie6=b.hasString("MSIE 6")&&!b.hasString("MSIE 7")&&!b.hasString("MSIE 8");a.ie=b.hasString("MSIE");a.tt=b.hasString("TencentTraveler");a.opera=window.opera||b.hasString("Opera");a.safari=b.hasString("WebKit");a.maxthon=!!(window.external&&window.external.max_version);return a}()};
UI.B.ie&&document.execCommand("BackgroundImageCache",false,true);window.console||(console={log:function(){},dir:function(){}});(function(){var a="UI.DatePicker",b=' href="javascript:void(0)"',c=' onfocus="this.blur()"',g=UI.html('<div class="date_picker" onclick="'+a+'.closeSelect();"><div class="wrap"></div><div class="time"><span class="timeTip"></span><span class="timeWrap"><input type="text" maxlength="2" class="hInput" onfocus="this.select();'+a+'.currentTimeSet = this;" onblur="'+a+'.selectedDate.setHours(this.value);" />:<input type="text" maxlength="2" class="mInput" onfocus="this.select();'+a+'.currentTimeSet = this;" onchange="'+
...
a+'.confirm();" /></div><ul class="list"></ul>'+(UI.B.ie6?'<iframe src="javascript:false"></iframe>':"")+"</div>")[0],o;UI.EA(g,"click",p);UI.DatePicker={body:g,wrap:m("wrap"),time:m("time"),list:m("list"),timeTip:m("timeTip"),timeConfirm:m("timeConfirm"),hInput:m("hInput"),mInput:m("mInput"),sInput:m("sInput"),yInput:function(){return UI.GC(this.wrap,".yearInput")[0].firstChild},MInput:function(){return UI.GC(this.wrap,".monthInput")[0].firstChild},iframe:UI.GT(g,"iframe")[0],target:0,format:0,display:0,
lang:0,weekStartDay:1,closeSelectTarget:0,disabledWeeks:[],disabledWeekDays:[],disabledDays:[],currentDate:0,currentWeek:0,currentTimeSet:0,selectedDate:0,selectedWeek:0,selectWeek:0,showWeek:0,tmpDate:0,date:{month:{en:["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"],en_US:["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"],zh_CN:["\u4e00\u6708","\u4e8c\u6708","\u4e09\u6708","\u56db\u6708","\u4e94\u6708","\u516d\u6708","\u4e03\u6708","\u516b\u6708",
...
h;e.format=k.replace(/m/g,"M");e.lang=n;this.show(i,e)},onWndClick:function(){}};function m(i){return UI.GC(g,"."+i)[0]}function f(){UI.DatePicker.hide()}function l(){top.UI.DatePicker.hide()}function p(i){UI.E(i).stop()}})();UI.Dialog=function(a){m.call(this,a);this._body=UI.DC("div");this._body.className="dialog2";this._body.innerHTML=(UI.B.ie6?'<iframe src="javascript:false;" class="cover_select"></iframe>':"")+'<div class="bg"></div><div style="margin:-'+a.height/2+"px 0 0 -"+a.width/2+"px;width:"+a.width+"px;height:"+a.height+'px;" class="wrap"><div class="title">'+a.title+'</div><a class="close '+(a.close!=false?"":"hide")+'" href="javascript:void '+a.name+'.hide();" onfocus="this.blur();" title="Close" tabindex="-1"></a><div class="cont"><div class="loading"><span>loading...</span></div><iframe allowtransparency="true" src="'+
...
this._title.offsetHeight;if(UI.B.ie&&document.compatMode=="CSS1Compat"){var l=parseInt(UI.C(this._title,"paddingTop"))+parseInt(UI.C(this._title,"paddingBottom"));this._titleHeight-=l;this._title.style.height=this._titleHeight-l+"px"}}try{this._cont.style.height=this._iframe.style.height=f.height-this._titleHeight+"px"}catch(p){}if(f.move==false){this.__move=false;this._title.style.cursor="default"}else if(this.__move==undefined||f.move){this.__move=true;this._title.style.cursor=""}if(f.resize==false){this.__resize=
false;this._resize.style.display="none"}else if(this.__resize==undefined||f.resize){this.__resize=true;this._resize.style.display=""}f.html&&UI.hide(this._loading)};this.__name=a.name;this._cache=[];this._append=false;this.autoHeightMax=420;this.__close=a.close==undefined?true:a.close;var b=this;a.url&&UI.EA(window,"load",function(){document.body.appendChild(b._body);b._append=true;b.__display=true;b.checkStaus.call(b,a);b._cache.push(a)});var c=this._wrap,g=this._border,o=a.name;this.key=function(f){switch(UI.E(f).key){case 27:window[o].__display&&
window[o].hide();break}};this.resizeBg=function(){if(b.__display){if(UI.B.ie)b._bg.style.cssText+=";width:100%;";b._body.style.height=UI.windowHeight();b.delay=setTimeout(function(){var f=UI.pageHeight(),l=UI.windowHeight();b._bg.style.cssText+=";width:"+UI.pageWidth()+"px;height:"+(f<l?l:f)+"px;"},0)}};UI.EA(document,"keyup",this.key);UI.EA(window,"resize",this.resizeBg);this._title.onmousedown=function(f){if(window[o].__move){f=window.event||f;var l=f.clientX-parseInt(c.style.marginLeft),p=f.clientY-
parseInt(c.style.marginTop),i=UI.windowWidth(),h=UI.windowHeight();f.preventDefault&&f.preventDefault();UI.addClass(c,"move");document.onmousemove=function(k){var n=window.event||k;k=UI.E(k);if(!UI.B.ie&&(k.x<0||k.y<0||k.x>i||k.y>h))return false;c.style.marginTop=n.clientY-p+"px";c.style.marginLeft=n.clientX-l+"px";return false};document.onmouseup=function(){this.onmousemove=null;document.onmouseup=null;UI.removeClass(c,"move")};return false}};this._title.ondblclick=function(){var f=window[o]._cache[window[o]._cache.length-
1];window[o].reset(f)};this._resize.onmousedown=function(f){if(window[o].__resize){var l=parseInt(UI.C(c,"width")),p=parseInt(UI.C(c,"height")),i=parseInt(UI.getY(c)),h=parseInt(UI.getX(c));if(!UI.B.ie||document.compatMode=="CSS1Compat"){l-=2;p-=2}g.style.cssText="top:"+i+"px;left:"+h+"px;width:"+l+"px;height:"+p+"px;display:block;";window[o]._body.style.cursor="se-resize";f=window.event||f;var k=f.clientX,n=f.clientY;f.preventDefault&&f.preventDefault();UI.addClass(c,"move");document.onmousemove=
function(e){e=window.event||e;var j=e.clientY-n,q=e.clientX-k;e=(150-l)/2;var r=(100-p)/2;if(j<r)j=r;if(q<e)q=e;var t="height:"+(j*2+p)+"px;width:"+(q*2+l)+"px;top:"+(i-j)+"px;left:"+(h-q)+"px;display:block;";if(UI.B.ie6&&document.compatMode=="BackCompat")setTimeout(function(){g.style.cssText=t},10);else g.style.cssText=t;return false};document.onmouseup=function(){window[o]._wrap.style.cssText="margin:0;left:"+g.style.left+";top:"+g.style.top+";width:"+g.offsetWidth+"px;height:"+g.offsetHeight+"px;";
window[o].checkStaus({height:g.offsetHeight});setTimeout(function(){g.style.display="none"},15);window[o]._body.style.cursor="";this.onmousemove=null;document.onmouseup=null;UI.removeClass(c,"move")};return false}};this._cont.onclick=function(){if(b.autoHeight){clearTimeout(b.delay);b.delay=setTimeout(function(){if(!b.__display)return false;b.height()},100)}};this.hide=function(){var f=UI.Dialog.cache;if(!this.__close||f[f.length-1]!=this.__name&&f.length>0)return false;var l=this._cache.length;if(l>
1){this.reset(this._cache[l-2]);this._cache[l-1].call&&eval(this._cache[l-1].call)}else if(l==0){UI.hide(this._body);return this.__display=false}else{UI.hide(this._body);if((l=this._cache[0].html)&&!UI.isString(l)){document.body.appendChild(l);UI.hide(l)}this._cache[0].call&&eval(this._cache[0].call);this.__display=false}this.__title=this._cache[0].title;this._cache.pop();if(this._cache.length<1&&f[f.length-1]==this.__name){f.pop();f.length>0&&UI.show(window[f[f.length-1]]._bg)}this.title()};this.show=
function(f){if(!this._append){document.body.appendChild(this._body);this._append=true}if(!this.__display){UI.show(this._body);this.__display=true}if(f){this.autoHeight=f.autoHeight||false;if(f.autoHeightMax)this.autoHeightMax=f.autoHeightMax;if(f.url||f.html){this._cache.push(f);var l=UI.Dialog.cache;if(l[l.length-1]!=this.__name){l.push(this.__name);for(var p=0,i=l.length-1;p<i;p++)UI.hide(window[l[p]]._bg)}this._cont.style.overflow=f.url?"hidden":"auto"}else if(f.title)this._cache[this._cache.length-
1].title=f.title;this.reset(f)}else this.reset({})};this.reset=function(f){f.title&&this.title();f.size&&m.call(this,f);var l=!!(f.html&&!UI.isString(f.html)&&!f.height);this._wrap.style.top="50%";this._wrap.style.left="50%";this._wrap.style.margin=-parseInt(UI.C(this._wrap,"height"))/2+UI.scrollY()+"px 0 0 "+(-parseInt(UI.C(this._wrap,"width"))/2+UI.scrollX())+"px";var p=UI.pageHeight(),i=UI.windowHeight();this._bg.style.cssText="width:"+UI.pageWidth()+"px;height:"+(p<i?i:p)+"px;";this._body.style.height=
UI.windowHeight();if(f.width){if(f.width%2)f.width+=1;this._wrap.style.width=f.width+"px";this._wrap.style.marginLeft=-f.width/2+UI.scrollX()+"px"}if(f.height){if(f.height%2)f.height+=1;this._wrap.style.height=f.height+"px";this._wrap.style.marginTop=-f.height/2+UI.scrollY()+"px"}if(f.close)this._close.className="close"+(f.close!=false?"":"hide");if(f.url){UI.hide(this._iframe);UI.show(this._loading);this._iframe.setAttribute("src",f.url)}else if(f.html){UI.hide(this._iframe);if(UI.isString(f.html)){UI.hide(this._loading);
this._data.innerHTML=f.html}else{this._data.appendChild(f.html);UI.show(f.html)}}this.checkStaus.call(this,f);l&&this.height()};this.title=function(){for(var f=[],l=0;l<this._cache.length;l++)this._cache[l].title&&f.push(this._cache[l].title);f.length==0&&f.push(this.__title);this._title.innerHTML="<span>"+f.join('<b class="dot"></b>')+"</span>"};this.height=function(){var f=UI.height(this._data)+this._titleHeight;this.show({autoHeight:this.autoHeight,height:f>this.autoHeightMax?this.autoHeightMax:
f})};function m(f){switch(f.size){case "small":if(!f.width)f.width=380;if(!f.height)f.height=220;break;case "medium":if(!f.width)f.width=530;if(!f.height)f.height=420;break;case "big":if(!f.width)f.width=760;if(!f.height)f.height=540;break}}};UI.Dialog.cache=[];UI.Dialog.location=null;UI.DragDrop=function(){};UI.DropMenu=function(a){a.open=false;if(UI.isString(a.id))a.id=UI.G(a.id);if(a.max==undefined)a.max=10;if(a.type==undefined)a.type=["click","click"];else if(a.type.length==1)a.type=[a.type,a.type];if(a.menu!=undefined){if(UI.isString(a.menu))a.menu=UI.G(a.menu);if(!a.id||!a.menu)return false;if(a.multi){a.parent=a.id.parentNode;var b=UI.GT(a.menu,"li");if(b.length>a.max){b=UI.C(b[0],"height");b=b=="auto"?20:b.slice(0,-2);a.menu.style.height=a.max*b+"px";a.menu.style.overflow="auto"}}UI.EA(document,
...
m=[],f=[],l='<iframe class="cover" src="javascript:false;"></iframe>';if(c)this.actions=c;i(this.actions);this.body.innerHTML=o.join("");UI.B.ie6&&UI.each(f,function(h){g.body.appendChild(h)});this.cover=f[0];c=this.body.getElementsByTagName("li");var p;UI.each(c,function(h){if(h.getAttribute("rel")=="son"){h.son=true;UI.addClass(h,"son")}if(UI.hasClass(h,"Input"))h.input=true;h.onclick=function(k){this.getAttribute("call")!=null&&m[this.getAttribute("call")].call(this);if(this.input){UI.E(k).stop();
var n=this.lastChild.previousSibling;k=this.firstChild;n.setAttribute("rel",n.getAttribute("rel")?"":"checked");var e=n.getAttribute("rel");if(n.className.match(/radio/g)){UI.each(this.parentNode.getElementsByTagName("b"),function(j){if(j.getAttribute("name")==n.getAttribute("name")){j.className="radio";j.setAttribute("rel","")}});n.setAttribute("rel","checked");n.className=n.className.split("_")[0]+"_checked";if(this.son){k.style.display="block";if(UI.B.ie6)f[k.getAttribute("iframe")].style.display=
"block"}}else{n.className=n.className.split("_")[0]+(e?"_"+e:"");k.style.display=this.son&&e=="checked"?"block":"none";if(UI.B.ie6)f[k.getAttribute("iframe")].style.display=k.style.display}return false}this.son?UI.E(k).stop():g.hide()};h.onmouseover=function(k){UI.addClass(this,"hover");if(this.son){if(this.input&&this.lastChild.previousSibling.getAttribute("rel")!="checked")return false;var n=this.firstChild;n.style.display="block";if(UI.E(k).target==this){if(!p)p=n.offsetWidth;n.style.left="";if(p+
UI.getX(n)>UI.windowWidth()||n.parentNode.parentNode.style.left!="")n.style.left=-p+"px"}if(UI.B.ie6)f[n.getAttribute("iframe")].style.cssText="display:block;top:"+(UI.getY(n)-UI.getY(g.body))+"px;left:"+(UI.getX(n)-UI.getX(g.body))+"px;width:"+n.offsetWidth+"px;height:"+n.offsetHeight+"px;"}};h.onmouseout=function(){UI.removeClass(this,"hover");if(this.son){var k=this.firstChild;k.style.display="";if(UI.B.ie6)f[k.getAttribute("iframe")].style.cssText=""}}});function i(h){var k,n,e;o.push('<ul iframe="'+
f.length+'">');UI.B.ie6&&f.push(UI.html(l)[0]);for(var j=0,q=h.length;j<q;j++){k=h[j].extend&&h[j].extend.match(/\binput\b/gi)?"Input":"";if(h[j].name){o.push("<li"+(h[j].data?' rel="son"':"")+(h[j].call?' call="'+m.length+'"':"")+' class="'+k+'">');h[j].call&&m.push(h[j].call);if(h[j].data){n=h[j].data;i(n)}if(h[j].extend){o.push(h[j].extend);n=h[j].extend.match(/\bchecked\b/gi)?"checked":"";e=h[j].extend.replace(/'/g,'"').match(/\bname="(\w*)"/gi);if(k)o.push("<b "+(e?e:"")+' rel="'+n+'" class="'+
(h[j].extend.match(/\bradio\b/gi)?"radio":"checkbox")+(n?"_"+n:"")+'"></b>')}o.push("<span>"+h[j].name+"</span></li>")}else o.push('<li class="line"></li>')}o.push("</ul>")}},show:function(c){c=UI.E(c);c.stop();if(!this.popupTmp&&(!this.actions||!this.actions.length)){this.hide();return false}if((!this.popupTmp||this.body.innerHTML=="")&&this.actionsCache)this.build();a.innerHTML!=""&&a.removeChild(a.firstChild);a.appendChild(this.body);a.style.display="block";this.display=true;var g=UI.windowWidth(),
o=this.body.offsetWidth,m=UI.windowHeight(),f=this.body.offsetHeight,l=UI.scrollX(),p=UI.scrollY(),i=c.x,h=c.y;a.style.top=h+p+"px";a.style.left=i+l+"px";a.style.margin="";if(o+c.x>g)a.style.marginLeft=-o+"px";if(f+c.y>m)a.style.marginTop=-f+"px";if(this.cover)this.cover.style.cssText="display:block;width:"+(o+2)+"px;height:"+(f+2)+"px;";if(this.popupTmp){this.actions=this.actionsCache;this.actionsCache=null}return this.popupTmp=false},hide:function(){a.style.display="none";if(this.cover)this.cover.style.cssText=
"";this.display=false}}})();UI.resize=function(a,b){a=UI.isObject(a)?[a]:UI.GC(a);UI.each(a,function(c){if("TEXTAREA,SELECT,INPUT,BUTTON,IMG".hasString(c.nodeName)){var g="",o="";if(UI.hasClass(c,"tipBox")){UI.removeClass(c,"tipBox");g=" tipBox";o=' title="'+c.title+'"';c.title="";UI.EA(c,"click",function(m){UI.E(m).stop()})}UI.wrap('<span class="resize_box'+g+'"'+o+'><b class="ico"></b><span></span></span>',c)}else{g=UI.html('<b class="ico"></b>')[0];c.appendChild(g)}new UI.Resize(c,b)})};
UI.Resize=function(a,b){var c=a.parentNode.parentNode,g=UI.GC(c,".ico")[0],o,m,f,l,p,i=0,h=0;if(b){if(!b.min)b.min={x:20,y:15};if(!b.max)b.max={x:Infinity,y:Infinity}}else b={min:{x:20,y:15},max:{x:Infinity,y:Infinity}};UI.drag(g,{start:function(k){k=UI.E(k);f=k.x;l=k.y;o=UI.width(a);m=UI.height(a);p=UI.C(g,"cursor");if(!UI.B.ie&&document.compatMode=="BackCompat"){k=g.parentNode;h=parseInt(UI.C(k,"paddingLeft"))+parseInt(UI.C(k,"paddingRight"));i=parseInt(UI.C(k,"paddingBottom"))+parseInt(UI.C(k,
...
"none";UI.removeClass(this.body,"top");this.click=this.display=false};this.show=function(){UI.addClass(this.body,"on");this.cont.style.display="block";var l=UI.height(this.cont),p=UI.height(this.input),i=UI.windowHeight();UI.pageHeight();var h=UI.getY(this.input),k=UI.scrollY(),n=this.tools&&!UI.B.ie&&document.compatMode=="BackCompat"?UI.height(this.tools):0;if(l+p+h-k>i){UI.addClass(this.body,"top");UI.height(this.cont)>=h-k&&UI.C(this.cont,"height",h-k-20-n+"px");UI.height(this.cont)>h&&UI.C(this.cont,
...
new UI.PopupMenu(this.body);this.popupMenu.setActions(this.popupMenuData.main);UI.EA(this.body,"mousedown",function(c){c=UI.E(c);if(c.button==2||UI.B.ie&&c.button==0)b.popupMenu.popup(b.popupMenuData.main)})}this.body.onselectstart=function(){return false}};
...
"icon";f.style.cssText="top:"+a[g].y+"px;left:"+a[g].x+"px;";UI.drag(f,{start:function(l){return function(p){p=UI.E(p);if(p.button==2||UI.B.ie&&p.button==0){c.currentId=UI.A(l,"rel").toString().split(",");c.current=c.findData(c.currentId.concat([]),c.data);c.popupMenu.popup(c.popupMenuData.son);c.rightClick=true;p.stop();return false}else c.rightClick=false;UI.addClass(c.body,"onMove");UI.addClass(l,"onSelf");UI.removeClass(l,"on");c.tmp=l.cloneNode(l,true);c.tmp.style.cssText="top:"+(p.y-c.y)+"px;left:"+
(p.x-c.x)+"px;";c.tmpBox.appendChild(c.tmp)}}(f),drag:function(l){l=UI.E(l);if(c.rightClick)return false;c.tmp.style.cssText="top:"+(l.y-c.y)+"px;left:"+(l.x-c.x)+"px;"},stop:function(l,p){return function(){if(c.rightClick)return false;var i=UI.GC(c.contBox,".on");if(i.length){var h=UI.A(i[0],"rel").toString().split(",");i=UI.A(l,"rel").toString().split(",");h=c.findData(h,c.data);if(h.son)h.son.push(p);else h.son=[p];try{c.findData(i.slice(0,-1),c.data).son.splice(i.slice(-1),1)}catch(k){c.data.splice(i.slice(-1),
