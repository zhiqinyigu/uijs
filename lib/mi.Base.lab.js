	...
	*/
	...
	UI.EA(o.target,'keydown',function(e){
		...
		if (E.key == 40 || E.key == 38) {
			...
			Self._cont.scrollTop = (Self.index - 4) * 21;
			Self.clicks = 1;
			clearTimeout(Self.delay);
			E.prevent();
		}
...
MI.AutoCmt.prototype = {
	...
	show : function(o, py){
		...
		//if (this.word) {
			...
			if (matchLength) {
				if (matchLength > 10) {
					this._cont.style.cssText = 'height:210px;overflow-y:scroll;overflow-x:hidden;';
				...
				var html = '<ul><li><img src="http://mat1.gtimg.com/www/mb/images/head_20.jpg"><span>' + match.join('</span></li><li><img src="http://mat1.gtimg.com/www/mb/images/head_20.jpg"><span>') + '</span></li></ul>' + this.tips;
				if (!word && !this.allList){
