...
MI.loadPM = function(_afJsOnload)
{
	var _sHost = location.protocol + "//pm.t.qq.com/",
		...
		_sJsUrl = [_sStaticHost, "zh_CN/htmledition/js/", _jsName, "?version=110726"].join(""),
		_sCssUrl = _sStaticHost + "zh_CN/htmledition/style/wbpm.css?v=110726";
...
MI.MayBeKnow= (function(){
	...
	function getData(){
        ...
        if(followingNum <= 30 && (UI.cookie('mb_mayBeKnown')==null) && weektime==6){
			MI.ajax({
	...
	function buildList(arr) {
		...
		UI.each(arr,function(p,i){
			...
			str += '<p><a class="uname" title="' + title + '" href="' + href + '" target="_blank">' + (p.bkName || p.nick) + '</a></p>';
...
MI.listDrop = function(o){
	this._id = o.id;
	this.ctrlHtml = ['<a href="http://qun.t.qq.com/">' + _('去微群集市逛逛') + '</a>','<a href="http://t.qq.com/lists.php">' + _('集市') + '</a>|<a href="#" class="creatList" onclick="MI.viewListHide&&MI.viewListHide();MI.List.add();MI.Bos(\'btnListViewAdd\');return false">' + _('创建') + '</a>|<a href="http://t.qq.com/list_mine.php" onclick="MI.Bos(\'btnListViewAdmin\')">' + _('管理') + '</a>'][o.type];
...
MI.TalkBox.prototype.addVote = function(){ // 新建投票
	...
	if (!Self._voteWrap){
		...
		UI.after(Self._voteWrap,Self.moreBox);
...
MI.Flash = {
    ...
    updateTip:function(version){
        ...
        html = '<p class="flashVersion" style="width:300px;padding:20px;text-align:center;">';
...
//多图上传开始
MI.PhotoMultiUpload = {
	html :'<div class="multiPic" style="padding:5px 0"><p style="padding-bottom:2px;color:#999;">' + _('按住Ctrl 键可一次选中并上传多张图片（最多8张），拖动图片可以调整顺序') + '</p><div class="flashWrap"></div><div class="clear"><p style="text-align:right;padding:10px 5px 5px 5px;" class="btnBox"><span class="error" style="margin-right:10px;"></span><button class="btn3 btnSend">' + _('确定') + '</button>&nbsp;<button class="btnCancel btn_cancel">' + _('取消') + '</button></p></div></div>',
	flashHtml:'<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="MultiPhoto" width="462" height="215" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab"><param name="movie" value="http://mat1.gtimg.com/www/mb/swf/MultiPhoto_110727.swf" /><param name="wmode" value="transparent" /><param name="quality" value="high" /><param name="allowScriptAccess" value="always"/><param value="' + MILang + '" name="langVer" /><embed src="http://mat1.gtimg.com/www/mb/swf/MultiPhoto_110727.swf" quality="high" width="462" height="215" name="MultiPhoto" align="middle" play="true" loop="false" quality="high" wmode="transparent" allowScriptAccess="always" langVer="' + MILang + '" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed></object>',
	body:null,
	sendBtn:null,
	cancelBtn:null,
	uploadUrl:'',
...
MI.Text2Pic = {
	html :'<div class="Text2Pic" style="padding:5px 0;text-align:center"><p style="padding-bottom:2px;color:#999;text-align:left;">' + _('帮您自动生成摘要，并保留链接、话题、@昵称') + '</p><textArea class="longText" style="height:300px;width:450px;padding:10px 0 10px 10px;border:1px solid #ccc;font-size:12px;line-height:1.8;overflow-y:auto;font-family:Microsoft YaHei"></textArea><div class="flashWrap" style="height:0;position:absolute;z-index:-10;left:15px;top:10px;"></div><div class="clear"><p style="text-align:right;padding:5px 0;" class="btnBox"><span class="tipPic" style="position:absolute;width:185px;height:75px;bottom:60px;right:30px;background:url(\'http://mat1.gtimg.com/www/mb/images/text2PicTip.png\') no-repeat;"></span><span class="tip" style="position:absolute;z-index:9;display:none;padding:20px 20px 20px 40px;bottom:160px;left:150px;border:5px solid #ccc;font:18px/21px \'MicroSoft YaHei\',\'Simhei\';color:#333;background:#fff url(\'http://mat1.gtimg.com/www/mb/images/loading.gif\') no-repeat 15px 50%;"></span><button class="btn3 btnSend">' + _('确定') + '</button>&nbsp;<button class="btnCancel btn_cancel">' + _('取消') + '</button></p></div></div>',
	flashHtml :'<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="Text2Pic" width="462" height="10" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab"><param name="movie" value="http://mat1.gtimg.com/www/mb/swf/Text2Pic_110729.swf" /><param name="wmode" value="transparent" /><param name="quality" value="high" /><param name="align" value="middle" /><param name="allowScriptAccess" value="always" /><param value="' + MILang + '" name="langVer" /> <embed src="http://mat1.gtimg.com/www/mb/swf/Text2Pic_110729.swf" quality="high" width="462" height="10"  name="Text2Pic" align="middle" play="true" loop="false" quality="high" wmode="transparent" allowScriptAccess="always" langVer="' + MILang + '" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed></object>',
	body:null,
	txt:null,
	sendBtn:null,
	cancelBtn:null,
	...
	build:function(url){
		...
		Self.wording = $$(Self.body,'.tipPic')[0];
    	Self.sendBtn.onclick = function(){Self.upload()};
	...
	setSummary:function(){
		var Self= this,
			...
			len = MI.countTxt(_txt.value,true),
			n = len<=92 ? 92 - len : 0; //talkBox中不满92字时，补充摘要字数
...
MI.SmartBox = function(id,callback,type,style){ //input element,callback,search type (keyword:用户输入的关键字提示,布尔值,可以为空）
	...
	var temp=null;
	if(this._key.parentNode.id=='searchForm') temp = this._key.parentNode;
	else if(this._key.parentNode.parentNode.id=='f1') temp = this._key.parentNode.parentNode;
	this._form = temp;
	//初始化smartbox容器
...
MI.SmartBox.prototype = {
				...
				MI.ajax({
					...
					success : function(data){
						...
						if (data.result == 0) {
							...
							else if(data2.length == 0){ //没有自动匹配的搜索关键词，右侧搜索框也出现“搜全站”和”搜我(他)的广播“
							    if(Self._valTip){
								    if (MI.boss == 13 || MI.boss == 7){ 
								    	Self.indexMax = 2;
										if(MI.guest){
	...
	submit : function(el){
		...
		if(this._callback){
			...
			if(el && UI.hasClass(el,'searchUser')){if(this._form != null) this._form.action="http://t.qq.com/search/user.php"; this._callback();}
			else
				this._callback(); 
		}
...
MI.Card = function(){ //Info Card    资料卡
	...
	Self._reFollow.onclick = function(){
		...
		Self.reFollow.show({
			...
			//talkId:Self.chName,
			cont : content,
			title:_('邀请 <b>{0}</b> 收听你:',Self.bkname || Self.name)
		});
...
MI.GoTop = {
	_body : UI.html('<div class="toolbar" style="display:">\
		<div class="tipsBox2">\
			<div class="qTalkBox"><a href="#" class="ico_qTips"></a><a href="#" class="btn_qTalk">' + _('QQ临时对话') + '<b class="mask"></b></a></div>\
			<div class="toolWrap" style="display:none">\
				<div class="toolBox">\
					<a href="http://t.qq.com/at?filter=0" class="ico_at" _title="提到我的" onmousedown="MI.Bos(\'btnMsgBoxAt\')">@</a><b class="mbg"></b>\
				</div>\
				<span id="newCout2At" class="bubbleW" style="display:none"><a href="http://t.qq.com/at?filter=0" onmousedown="MI.Bos(\'btnMsgBoxAtNum\')"></a><span class="bubble"></span></span>\
			</div>\
			<div class="toolWrap" style="display:none">\
				<div class="toolBox">\
					<a href="http://t.qq.com/' + MI.user.account + '/follower" class="ico_foer" title="听众" onmousedown="MI.Bos(\'btnMsgBoxFollower\')"></a><b class="mbg"></b>\
				</div>\
				<span id="newCount2Follower" class="bubbleW" style="display:none"><a href="http://t.qq.com/' + MI.user.account + '/follower" onmousedown="MI.Bos(\'btnMsgBoxFollowerNum\')"></a><span class="bubble"></span></span>\
			</div>\
			<div class="mSimpleBox hover" style="display:none"><button class="btn_mPlay">' + _('播放') + '<b class="mask"></b></button><button class="btn_mPause" style="display:none">' + _('暂停') + '<b class="mask"></b></button><b class="mbg"></b></div>\
		</div>\
		<div class="tNewsTips" style="display:none">\
			<p><a href="http://t.qq.com/at?filter=1" onmousedown="MI.Bos(\'btnMsgBoxAtFollowing\')">我收听的人@我<em rel="1"></em></a></p>\
			<p><a href="http://t.qq.com/at?filter=2" onmousedown="MI.Bos(\'btnMsgBoxAtVip\')">认证用户@我<em rel="2"></em></a></p>\
			<p><a href="http://t.qq.com/at?filter=0" onmousedown="MI.Bos(\'btnMsgBoxAtAll\')">所有@我的<em rel="0"></em></a></p>\
			<p><a href="http://t.qq.com/messages/inbox" onmousedown="MI.Bos(\'btnMsgBoxMsg\')">我的私信<em id="newCout2Msg"></em></a></p>\
			<a href="http://t.qq.com/setting/others" target="_blank" class="btn_moreSet"></a>\
		</div>\
		<div class="sToolbar">\
	...
	btnNum : 1,
	rightFix : 0, //-40
	btnClass : ['sToolbar single','sToolbar single','sToolbar single'],
	...
	build : function() {
		...
		if (_main) {
			...
			Self._atTips = $$(Self._body,'.tNewsTips')[0]; //At浮层
			Self._mBox = $$(Self._body,'.mSimpleBox')[0]; //音乐
			Self._toolBar = $$(Self._body,'.sToolbar')[0]; //返回顶部和音乐播放
			Self._msgBox = $$(Self._body,'.toolWrap,.mSimpleBox'); //消息盒子
			...
			Self._at.onmouseover = Self._atNum.onmouseover = Self._atTips.onmouseover = function(){
				...
				if (UI.text(Self._atNum) && !UI.A(Self._atNum,'onlyAll')){
					UI.addClass(Self._at.parentNode.parentNode,'showNews');
					UI.show(Self._atTips);
				}
			}
			Self._at.onmouseout = Self._atNum.onmouseout = Self._atTips.onmouseout = function(){
				delay = setTimeout(function(){
					UI.removeClass(Self._at.parentNode.parentNode,'showNews');
		...
		function set(){
			...
			Self.btnSet();
			pageHeight = Math.min(document.body.scrollHeight,document.documentElement.scrollHeight);
			y = scrollY + windowHeight - pageHeight;
			if (y >= -foot || noScroll) {
				Self._body.style.cssText += ';position:absolute;top:' + (pageHeight - 27 - foot) + 'px';
	...
	msgBoxWidth : 0,
	getMsgBoxWidth : function(){ //计算消息盒子宽度
		var Self = this;
		Self.msgBoxWidth = 0;
	...
	showMsgBox : function(){ //显示消息盒子
		if (!(MI.user.fun.goTop && MI.user.account && MI.user.fun.msgBox==1)){
			return;
		}
		var Self = this,
			newCoutAt = $('newCoutAt');
		if (newCoutAt && UI.scrollY() < 455 || (UI.C($('newCout2At'),'display') == 'none' && UI.C($('newCount2Follower'),'display') == 'none')){
			Self.hideMsgBox();
		}
		else {
			UI.each(Self._msgBox,function(o){
				if (UI.hasClass(o,'toolWrap')){
					UI.show(o);
				}
			});
		}
