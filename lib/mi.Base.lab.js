...
MI.tmpl.card = '<div class="uCard"><div class="tip">' + _('这是你自己') + '</div><div class="tip"></div><div class="userPic"><a></a><p class="btn"><input type="button" class="addAttention" value="" /><a href="#" class="delAttention" title="' + _('取消收听') + '">' + _('取消') + '</a></p></div><div class="uCardcnt"><p class="userName"></p><p class="nums loading"></p><p class="btn"><a href="#" class="note">' + _('备注') + '</a><a href="#" class="reply">' + _('对话') + '</a><a href="#" class="msg">' + _('私信') + '</a><a href="#" class="black">' + _('拉黑') + '</a></p><div class="tagBox"></div><a href="#" class="ico_sFo"></a></div></div>';
...
MI.TalkBox.prototype.addAt = function(){
	var Self = this;
	if (!Self._atBox){
		Self._atBox = UI.html('<div class="atWrap" style="display:none">\
				<div class="musicTab" style=""><div class="atSearch"><input type="text" class="inputTxt"><span class="atbtn"><input type="button" class="btn_search2"><a href="#" class="del"></a></span></div><a href="#" class="close"></a></div>\
				<div class="autoCmt" style="height:120px"><ul></ul></div>\
			</div>')[0];
		UI.after(Self._atBox,document.body);
		UI.EA(document.body,'click',function(){
			Self.hideAt();
		});
	}
	if (Self._atBox.style.display == 'none'){
		setTimeout(function(){
			Self._atBox.style.cssText = 'top:' + (UI.getY(Self._at) + UI.height(Self._at) + 5) + 'px;left:' + (UI.getX(Self._at) - 50) + 'px';
		},0);
	}
	else {
		Self._atBox.style.cssText = 'display:none';
	}
}
MI.TalkBox.prototype.hideAt = function(){
	var Self = this;
	if (Self._atBox){
		UI.hide(Self._atBox);
	}
...
MI.TalkList.prototype.share = function(btn,id){ // 分享
	...
	//<p><a href="#">分享到邮件</a></p><p><a href="#">分享到QZone</a></p><p><a href="#">复制链接分享</a></p>
	/*if (!Self._share) {
...
MI.AutoCmt.prototype = {
	_body : UI.html('<div class="atWrap" style="display:none">\
		<div class="musicTab"><div class="atSearch"><input type="text" class="inputTxt"><span class="atbtn"><input type="button" class="btn_search2"><a href="#" class="del"></a></span></div><a href="#" class="close"></a></div>\
	...
	show : function(o, py){
		...
		//if (this.word) {
			...
			if (matchLength) {
				...
				var html = '<ul><li class="on"><img src="http://mat1.gtimg.com/www/mb/images/head_20.jpg"><span>' + match.join('</span></li><li><img src="http://mat1.gtimg.com/www/mb/images/head_20.jpg"><span>') + '</span></li></ul>' + this.tips;
				if (!word && !this._all.innerHTML){
				...
				this.display = 0;
				this.index = 0;
				this.indexMax = (this.allList || this.keyList).length - 1;
			}
			else {
...
MI.Card.prototype = {
	...
	show : function(el){
		...
		function show(o){
			...
			if (o.tag) {
				Self._tag.innerHTML = '<h5></h5>' + _('标签：') + o.tag + '';
	...
	num : function(o){
		var num = o.num;
		this._num.innerHTML = _('广播{0}条',num[0]) + '<span>' + (o.flag.vivi ? '' : '|</span>' + _('听众{0}人',num[1]) + '<span>');//|</span>收听了' + num[2] + '人
	},
	hide : function(){
		var Self = this;
