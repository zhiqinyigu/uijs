...
MI.Card = function(){ //Info Card    资料卡
	...
	Self._chat.onclick = function(){
		...
		MI.app({
			WebQQ:function(){
				MI.WebQQ.chat(Self.account,Self.name,Self.avatar);
			}
		})
		return false;
	}
	...
	Self._recom.onclick = function(){
		...
		Self.recom.show({cont:_('#推荐收听# {0} 是个挺有趣的人，大家快来强势围观它吧。','@'+recomBox.talkTo)});
